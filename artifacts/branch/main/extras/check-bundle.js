...
function requireMs() {
  ...
  function _(u) {
    var c = Math.abs(u);
    return c >= i ? Math.round(u / i) + "d" : c >= n ? Math.round(u / n) + "h" : c >= e ? Math.round(u / e) + "m" : c >= t ? Math.round(u / t) + "s" : u + "ms";
  }
  function l(u) {
    var c = Math.abs(u);
    return c >= i ? o(u, c, i, "day") : c >= n ? o(u, c, n, "hour") : c >= e ? o(u, c, e, "minute") : c >= t ? o(u, c, t, "second") : u + " ms";
  }
  function o(u, c, d, f) {
    var h = c >= d * 1.5;
...
function requireCommon() {
  ...
  hasRequiredCommon = 1;
  function t(e) {
    i.debug = i, i.default = i, i.coerce = o, i.disable = _, i.enable = a, i.enabled = l, i.humanize = requireMs(), i.destroy = u, Object.keys(e).forEach((c) => {
      i[c] = e[c];
    ...
    function i(c) {
      ...
      return m.namespace = c, m.useColors = i.useColors(), m.color = i.selectColor(c), m.extend = r, m.destroy = i.destroy, Object.defineProperty(m, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => f !== null ? f : (h !== i.namespaces && (h = i.namespaces, p = i.enabled(c)), p),
        set: (v) => {
          f = v;
        }
...
var __awaiter$2 = function(t, e, n, i) {
  ...
  return new (n || (n = Promise))(function(a, s) {
    ...
    function o(u) {
      u.done ? a(u.value) : r(u.value).then(_, l);
    }
...
var headerLengthInElements = 20, extrasLengthInElements = 1, Int32Section = class {
  ...
  updateFromParams(t, e, n) {
    ...
    let c = 0;
    function d(S, M) {
      const O = c, N = S === "float64" ? Float64Array.BYTES_PER_ELEMENT : Int32Array.BYTES_PER_ELEMENT, L = Math.round(M * N), C = Math.ceil(L / 8) * 8;
      return c += C, O;
    }
    const f = d("int32", headerLengthInElements), h = d("float64", extrasLengthInElements), p = d("float64", i), m = d("float64", r), v = d("int32", a), g = d("float64", _), b = d("int32", l), I = d("float64", o), w = d("int32", u), k = c;
...
async function spawnAsyncModelRunnerWithWorker(t) {
  ...
  return {
    ...
    runModel: async (_, l, o) => {
      ...
      let u;
      try {
        u = await e.runModel(Transfer(r.getEncodedBuffer()));
      } finally {
        a = !1;
      }
      return r.updateFromEncodedBuffer(u), r.finalizeOutputs(l), l;
    },
...
function foldFlowLines(t, e, n = "flow", { indentAtStart: i, lineWidth: r = 80, minContentWidth: a = 20, onFold: s, onOverflow: _ } = {}) {
  ...
  const o = [], u = {};
  let c = r - e.length;
  typeof i == "number" && (i > r - Math.max(2, a) ? o.push(0) : c = r - i);
...
function blockString({ comment: t, type: e, value: n }, i, r, a) {
  ...
  const o = i.indent || (i.forceBlockIndent || containsDocumentMarker(n) ? "  " : ""), u = s === "literal" ? !0 : s === "folded" || e === Scalar.BLOCK_FOLDED ? !1 : e === Scalar.BLOCK_LITERAL ? !0 : !lineLengthOverLimit(n, l, o.length);
  if (!n)
    return u ? `|
` : `>
`;
...
function plainString(t, e, n, i) {
  const { type: r, value: a } = t, { actualString: s, implicitKey: _, indent: l, indentStep: o, inFlow: u } = e;
  if (_ && a.includes(`
`) || u && /[[\]{},]/.test(a))
...
`) ? quotedString(a, e) : blockString(t, e, n, i);
  if (!_ && !u && r !== Scalar.PLAIN && a.includes(`
`))
...
function stringifyString(t, e, n, i) {
  ...
  let o = l(_);
  if (o === null) {
    const { defaultKeyType: u, defaultStringType: c } = e.options, d = r && u || c;
    if (o = l(d), o === null)
...
function stringifyBlockCollection({ comment: t, items: e }, n, { blockItemPrefix: i, flowChars: r, itemIndent: a, onChompKeep: s, onComment: _ }) {
  ...
  for (let h = 0; h < e.length; ++h) {
    ...
    m && (v += lineComment(v, a, o(m))), c && m && (c = !1), d.push(i + v);
  }
  let f;
  if (d.length === 0)
    f = r.start + r.end;
...
`)), h < t.length - 1 ? v += "," : e.options.trailingComma && (e.options.lineWidth > 0 && (o || (o = c.reduce((g, b) => g + b.length + 2, 2) + (v.length + 2) > e.options.lineWidth)), o && (v += ",")), m && (v += lineComment(v, i, _(m))), c.push(v), u = c.length;
  }
...
const inputSpecs = [{ inputId: "1", varId: "_enrollment_strategy_strength", varName: "enrollment strategy strength", defaultValue: 0, minValue: -1, maxValue: 2 }, { inputId: "2", varId: "_fee_waiver_strategy_strength", varName: "fee waiver strategy strength", defaultValue: 0, minValue: -1, maxValue: 2 }, { inputId: "3", varId: "_delay_reduction_strategy_strength", varName: "delay reduction strategy strength", defaultValue: 0, minValue: -0.5, maxValue: 0.917 }, { inputId: "4", varId: "_reimbursement_strategy_strength", varName: "reimbursement strategy strength", defaultValue: 0, minValue: -0.5, maxValue: 0.43 }, { inputId: "5", varId: "_screen_strategy_strength", varName: "screen strategy strength", defaultValue: 0, minValue: -0.5, maxValue: 2 }, { inputId: "6", varId: "_provider_number_strategy_strength", varName: "provider number strategy strength", defaultValue: 0, minValue: -0.5, maxValue: 1 }, { inputId: "7", varId: "_provider_strategy_strength", varName: "provider strategy strength", defaultValue: 0, minValue: -0.5, maxValue: 0.43 }, { inputId: "8", varId: "_restock_strategy_strength", varName: "restock strategy strength", defaultValue: 0, minValue: -1, maxValue: 2 }, { inputId: "9", varId: "_unutilized_revenue_strategy_strength", varName: "unutilized revenue strategy strength", defaultValue: 0, minValue: 0, maxValue: 1 }, { inputId: "10", varId: "_dropout_rate", varName: "dropout rate", defaultValue: 0.178522, minValue: 1e-4, maxValue: 1 }, { inputId: "11", varId: "_base_enrollment_rate", varName: "base enrollment rate", defaultValue: 0.754865, minValue: 1e-4, maxValue: 1 }, { inputId: "12", varId: "_new_fee_waiver_rate", varName: "new fee waiver rate", defaultValue: 0.0173221, minValue: 1e-4, maxValue: 1 }, { inputId: "13", varId: "_fee_waiver_adjustment_rate", varName: "fee waiver adjustment rate", defaultValue: 1e-5, minValue: 1e-5, maxValue: 1 }, { inputId: "14", varId: "_strength_of_perceived_benefit", varName: "strength of perceived benefit", defaultValue: 0.606183, minValue: 1e-3, maxValue: 5 }, { inputId: "15", varId: "_initial_fee_waivered_population", varName: "initial fee waivered population", defaultValue: 428123, minValue: 100, maxValue: 1e6 }, { inputId: "16", varId: "_population_adjustment", varName: "population adjustment", defaultValue: 291349, minValue: 1e3, maxValue: 5e8 }, { inputId: "17", varId: "_ncd_development_rate[_htn]", varName: "NCD development rate[HTN]", defaultValue: 0.0102388, minValue: 0.01, maxValue: 0.1 }, { inputId: "18", varId: "_base_ncd_screening_propensity[_htn]", varName: "base NCD screening propensity[HTN]", defaultValue: 0.0541244, minValue: 1e-3, maxValue: 0.2 }, { inputId: "19", varId: "_base_ncd_screening_propensity[_dia]", varName: "base NCD screening propensity[DIA]", defaultValue: 0.0558751, minValue: 1e-3, maxValue: 0.2 }, { inputId: "20", varId: "_treated_ncd_death_risk_relative_to_untreated[_htn]", varName: "treated NCD death risk relative to untreated[HTN]", defaultValue: 0.336496, minValue: 1e-3, maxValue: 0.5 }, { inputId: "21", varId: "_discontinuation_rate[_htn]", varName: "discontinuation rate[HTN]", defaultValue: 391406e-8, minValue: 1e-3, maxValue: 0.1 }, { inputId: "22", varId: "_strength_coverage_on_screen[_htn]", varName: "strength coverage on screen[HTN]", defaultValue: 1.00853, minValue: 1e-3, maxValue: 10 }, { inputId: "23", varId: "_ncd_development_rate[_dia]", varName: "NCD development rate[DIA]", defaultValue: 324548e-8, minValue: 1e-3, maxValue: 0.1 }, { inputId: "24", varId: "_base_tx_enrollment_rate_post_screening[_dia]", varName: "base tx enrollment rate post screening[DIA]", defaultValue: 1, minValue: 1e-3, maxValue: 1 }, { inputId: "25", varId: "_base_tx_enrollment_rate_post_screening[_htn]", varName: "base tx enrollment rate post screening[HTN]", defaultValue: 1, minValue: 1e-3, maxValue: 1 }, { inputId: "26", varId: "_relative_death_risk_for_ncd[_dia]", varName: "relative death risk for NCD[DIA]", defaultValue: 6.38518, minValue: 1, maxValue: 10 }, { inputId: "27", varId: "_relative_death_risk_for_ncd[_htn]", varName: "relative death risk for NCD[HTN]", defaultValue: 1.32908, minValue: 1, maxValue: 10 }, { inputId: "28", varId: "_treated_ncd_death_risk_relative_to_untreated[_dia]", varName: "treated NCD death risk relative to untreated[DIA]", defaultValue: 0.135347, minValue: 1e-3, maxValue: 0.5 }, { inputId: "29", varId: "_discontinuation_rate[_dia]", varName: "discontinuation rate[DIA]", defaultValue: 310638e-8, minValue: 1e-3, maxValue: 0.5 }, { inputId: "30", varId: "_base_death_rate", varName: "base death rate", defaultValue: 387393e-9, minValue: 1e-5, maxValue: 0.01 }, { inputId: "31", varId: "_strength_coverage_on_screen[_dia]", varName: "strength coverage on screen[DIA]", defaultValue: 0.779135, minValue: 1e-3, maxValue: 10 }, { inputId: "32", varId: "_base_positive_ncd_fraction_for_screened_people[_htn]", varName: "base positive NCD fraction for screened people[HTN]", defaultValue: 0.231588, minValue: 0.1, maxValue: 0.6 }, { inputId: "33", varId: "_base_positive_ncd_fraction_for_screened_people[_dia]", varName: "base positive NCD fraction for screened people[DIA]", defaultValue: 0.05, minValue: 0.05, maxValue: 0.3 }, { inputId: "34", varId: "_reference_utilization_per_capita", varName: "reference utilization per capita", defaultValue: 0.189723, minValue: 1e-3, maxValue: 10 }, { inputId: "35", varId: "_base_average_fee_per_person", varName: "base average fee per person", defaultValue: 1607.55, minValue: 1, maxValue: 2e3 }, { inputId: "36", varId: "_base_average_reimbursement_per_person", varName: "base average reimbursement per person", defaultValue: 457.327, minValue: 1, maxValue: 2e3 }, { inputId: "37", varId: "_cost_to_fee_ratio", varName: "cost to fee ratio", defaultValue: 0.704884, minValue: 0.3, maxValue: 0.95 }, { inputId: "38", varId: "_initial_average_annual_ir", varName: "initial average annual IR", defaultValue: 187328e4, minValue: 1e6, maxValue: 1e10 }, { inputId: "39", varId: "_initial_cbhi_revenue", varName: "initial CBHI revenue", defaultValue: 77955e5, minValue: 1e3, maxValue: 1e10 }, { inputId: "40", varId: "_provider_adjustment_rate", varName: "provider adjustment rate", defaultValue: 257.727, minValue: 10, maxValue: 1e4 }, { inputId: "41", varId: "_initial_providers", varName: "initial providers", defaultValue: 205.988, minValue: 100, maxValue: 1e5 }, { inputId: "42", varId: "_base_medication_restocking_rate", varName: "base medication restocking rate", defaultValue: 0.471924, minValue: 0.1, maxValue: 3 }, { inputId: "43", varId: "_subsidy_fraction", varName: "subsidy fraction", defaultValue: 0.124199, minValue: 0.01, maxValue: 1 }, { inputId: "44", varId: "_initial_prevalence[_htn]", varName: "initial prevalence[HTN]", defaultValue: 0.195995, minValue: 0.15, maxValue: 0.3 }, { inputId: "45", varId: "_initial_prevalence[_dia]", varName: "initial prevalence[DIA]", defaultValue: 0.0787616, minValue: 0.05, maxValue: 0.15 }, { inputId: "46", varId: "_initial_fraction_in_treatment[_htn]", varName: "initial fraction in treatment[HTN]", defaultValue: 0.179792, minValue: 5e-3, maxValue: 0.4 }, { inputId: "47", varId: "_initial_fraction_in_treatment[_dia]", varName: "initial fraction in treatment[DIA]", defaultValue: 0.166947, minValue: 1e-3, maxValue: 0.4 }, { inputId: "48", varId: "_internal_revenue_execution_rate", varName: "internal revenue execution rate", defaultValue: 0.753259, minValue: 0.1, maxValue: 0.9 }, { inputId: "49", varId: "_strength_of_med_availability_on_enrollment[_htn]", varName: "strength of med availability on enrollment[HTN]", defaultValue: 0.173977, minValue: 1e-3, maxValue: 1 }, { inputId: "50", varId: "_strength_of_med_availability_on_enrollment[_dia]", varName: "strength of med availability on enrollment[DIA]", defaultValue: 0.774647, minValue: 1e-3, maxValue: 1 }, { inputId: "51", varId: "_strength_of_med_availability_on_discontinuation[_htn]", varName: "strength of med availability on discontinuation[HTN]", defaultValue: 1e-3, minValue: 1e-3, maxValue: 1 }, { inputId: "52", varId: "_strength_of_med_availability_on_discontinuation[_dia]", varName: "strength of med availability on discontinuation[DIA]", defaultValue: 1, minValue: 1e-3, maxValue: 1 }], outputSpecs = [{ varId: "_cbhi_beneficiaries", varName: "CBHI beneficiaries" }, { varId: "_fee_waivered_population_with_health_coverage", varName: "Fee waivered population with health coverage" }, { varId: "_fraction_in_treatment[_dia]", varName: "Fraction in treatment[DIA]" }, { varId: "_fraction_in_treatment[_htn]", varName: "Fraction in treatment[HTN]" }, { varId: "_essential_medication_availability", varName: "essential medication availability" }, { varId: "_frac_adult_of_pop_with_coverage", varName: "frac adult of pop with coverage" }, { varId: "_new_enrollment_into_care[_dia]", varName: "new enrollment into care[DIA]" }, { varId: "_new_enrollment_into_care[_htn]", varName: "new enrollment into care[HTN]" }, { varId: "_people_screened_for_ncd[_dia]", varName: "people screened for NCD[DIA]" }, { varId: "_people_screened_for_ncd[_htn]", varName: "people screened for NCD[HTN]" }, { varId: "_total_service_utilization_per_capita", varName: "total service utilization per capita" }], encodedImplVars = { subscripts: [{ n: "DIA", i: "_dia" }, { n: "HTN", i: "_htn" }], variables: [{ n: "FINAL TIME", i: "_final_time", x: 1 }, { n: "INITIAL TIME", i: "_initial_time", x: 2 }, { n: "NCD development rate", i: "_ncd_development_rate", x: 3 }, { n: "OneYear", i: "_oneyear", x: 4 }, { n: "TIME STEP", i: "_time_step", x: 5 }, { n: "alpha", i: "_alpha", x: 6 }, { n: "annual health service utilization per NCD patient", i: "_annual_health_service_utilization_per_ncd_patient", x: 7 }, { n: "annual inflation rate", i: "_annual_inflation_rate", x: 8 }, { n: "average reimbursement delay", i: "_average_reimbursement_delay", x: 9 }, { n: "avg adult pop per household", i: "_avg_adult_pop_per_household", x: 10 }, { n: "base NCD screening propensity", i: "_base_ncd_screening_propensity", x: 11 }, { n: "base average fee per person", i: "_base_average_fee_per_person", x: 12 }, { n: "base average reimbursement per person", i: "_base_average_reimbursement_per_person", x: 13 }, { n: "base death rate", i: "_base_death_rate", x: 14 }, { n: "base enrollment rate", i: "_base_enrollment_rate", x: 15 }, { n: "base medication restocking rate", i: "_base_medication_restocking_rate", x: 16 }, { n: "base medication utilization rate", i: "_base_medication_utilization_rate", x: 17 }, { n: "base positive NCD fraction for screened people", i: "_base_positive_ncd_fraction_for_screened_people", x: 18 }, { n: "base provider per facility", i: "_base_provider_per_facility", x: 19 }, { n: "base tx enrollment rate post screening", i: "_base_tx_enrollment_rate_post_screening", x: 20 }, { n: "beta", i: "_beta", x: 21 }, { n: "change time", i: "_change_time", x: 22 }, { n: "cost to fee ratio", i: "_cost_to_fee_ratio", x: 23 }, { n: "delay reduction strategy start year", i: "_delay_reduction_strategy_start_year", x: 24 }, { n: "delay reduction strategy strength", i: "_delay_reduction_strategy_strength", x: 25 }, { n: "discontinuation rate", i: "_discontinuation_rate", x: 26 }, { n: "dropout rate", i: "_dropout_rate", x: 27 }, { n: "eff of coverage on service utilization", i: "_eff_of_coverage_on_service_utilization", x: 28 }, { n: "enrollment strategy start year", i: "_enrollment_strategy_start_year", x: 29 }, { n: "enrollment strategy strength", i: "_enrollment_strategy_strength", x: 30 }, { n: "facilities in Amhara", i: "_facilities_in_amhara", x: 31 }, { n: "facility stock adjustment time", i: "_facility_stock_adjustment_time", x: 32 }, { n: "fee waiver adjustment rate", i: "_fee_waiver_adjustment_rate", x: 33 }, { n: "fee waiver strategy start year", i: "_fee_waiver_strategy_start_year", x: 34 }, { n: "fee waiver strategy strength", i: "_fee_waiver_strategy_strength", x: 35 }, { n: "fraction allocated to RDF", i: "_fraction_allocated_to_rdf", x: 36 }, { n: "fraction of day in clinic time", i: "_fraction_of_day_in_clinic_time", x: 37 }, { n: "household adjustment time", i: "_household_adjustment_time", x: 38 }, { n: "household size adj for fees", i: "_household_size_adj_for_fees", x: 39 }, { n: "initial CBHI revenue", i: "_initial_cbhi_revenue", x: 40 }, { n: "initial average annual IR", i: "_initial_average_annual_ir", x: 41 }, { n: "initial fee waivered population", i: "_initial_fee_waivered_population", x: 42 }, { n: "initial fraction in treatment", i: "_initial_fraction_in_treatment", x: 43 }, { n: "initial prevalence", i: "_initial_prevalence", x: 44 }, { n: "initial providers", i: "_initial_providers", x: 45 }, { n: "initial tot demand minute ratio", i: "_initial_tot_demand_minute_ratio", x: 46 }, { n: "internal revenue execution rate", i: "_internal_revenue_execution_rate", x: 47 }, { n: "minutes per visit", i: "_minutes_per_visit", x: 48 }, { n: "net enrollment rate in 2007", i: "_net_enrollment_rate_in_2007", x: 49 }, { n: "new fee waiver rate", i: "_new_fee_waiver_rate", x: 50 }, { n: "population adjustment", i: "_population_adjustment", x: 51 }, { n: "procurement responsiveness", i: "_procurement_responsiveness", x: 52 }, { n: "provider adjustment rate", i: "_provider_adjustment_rate", x: 53 }, { n: "provider number strategy strength", i: "_provider_number_strategy_strength", x: 54 }, { n: "provider productivity strategy start year", i: "_provider_productivity_strategy_start_year", x: 55 }, { n: "provider strategy start year", i: "_provider_strategy_start_year", x: 56 }, { n: "provider strategy strength", i: "_provider_strategy_strength", x: 57 }, { n: "reference utilization per capita", i: "_reference_utilization_per_capita", x: 58 }, { n: "reimbursement strategy start year", i: "_reimbursement_strategy_start_year", x: 59 }, { n: "reimbursement strategy strength", i: "_reimbursement_strategy_strength", x: 60 }, { n: "relative death risk for NCD", i: "_relative_death_risk_for_ncd", x: 61 }, { n: "responsiveness strategy start year", i: "_responsiveness_strategy_start_year", x: 62 }, { n: "responsiveness strategy strength", i: "_responsiveness_strategy_strength", x: 63 }, { n: "restock strategy start year", i: "_restock_strategy_start_year", x: 64 }, { n: "restock strategy strength", i: "_restock_strategy_strength", x: 65 }, { n: "revenue utilization time", i: "_revenue_utilization_time", x: 66 }, { n: "screen strategy start year", i: "_screen_strategy_start_year", x: 67 }, { n: "screen strategy strength", i: "_screen_strategy_strength", x: 68 }, { n: "strength coverage on screen", i: "_strength_coverage_on_screen", x: 69 }, { n: "strength of med availability on discontinuation", i: "_strength_of_med_availability_on_discontinuation", x: 70 }, { n: "strength of med availability on enrollment", i: "_strength_of_med_availability_on_enrollment", x: 71 }, { n: "strength of perceived benefit", i: "_strength_of_perceived_benefit", x: 72 }, { n: "subsidy fraction", i: "_subsidy_fraction", x: 73 }, { n: "time to enroll", i: "_time_to_enroll", x: 74 }, { n: "total annual clinical minutes per provider", i: "_total_annual_clinical_minutes_per_provider", x: 75 }, { n: "transition time", i: "_transition_time", x: 76 }, { n: "treated NCD death risk relative to untreated", i: "_treated_ncd_death_risk_relative_to_untreated", x: 77 }, { n: "unutilized revenue strategy start year", i: "_unutilized_revenue_strategy_start_year", x: 78 }, { n: "unutilized revenue strategy strength", i: "_unutilized_revenue_strategy_strength", x: 79 }, { n: "DATA Amhara total population 30 yo plus", i: "_data_amhara_total_population_30_yo_plus", x: 80 }, { n: "DATA CBHI membership cost per household", i: "_data_cbhi_membership_cost_per_household", x: 81 }, { n: "DATA CBHI targeted households", i: "_data_cbhi_targeted_households", x: 82 }, { n: "DATA Essential medication availability DIA", i: "_data_essential_medication_availability_dia", x: 83 }, { n: "DATA Essential medication availability HTN", i: "_data_essential_medication_availability_htn", x: 84 }, { n: "DATA inflation conversion multiplier for 2017 birr value", i: "_data_inflation_conversion_multiplier_for_2017_birr_value", x: 85 }, { n: "DATA total CBHI reimbursements", i: "_data_total_cbhi_reimbursements", x: 86 }, { n: "DATA total CBHI reimbursements requested", i: "_data_total_cbhi_reimbursements_requested", x: 87 }, { n: "DATA total revolving drug funds", i: "_data_total_revolving_drug_funds", x: 88 }, { n: "initial CBHI beneficiaries", i: "_initial_cbhi_beneficiaries", x: 89 }, { n: "DATA Essential medication availability avg", i: "_data_essential_medication_availability_avg", x: 90 }, { n: "initial essential medicine availability", i: "_initial_essential_medicine_availability", x: 91 }, { n: "initial facilities with medication", i: "_initial_facilities_with_medication", x: 92 }, { n: "Facilities with medication", i: "_facilities_with_medication", x: 93 }, { n: "initial facilities without medication", i: "_initial_facilities_without_medication", x: 94 }, { n: "Facilities without medication", i: "_facilities_without_medication", x: 95 }, { n: "Fee waivered population with health coverage", i: "_fee_waivered_population_with_health_coverage", x: 96 }, { n: "CBHI beneficiaries", i: "_cbhi_beneficiaries", x: 97 }, { n: "total adult population with coverage", i: "_total_adult_population_with_coverage", x: 98 }, { n: "frac adult of pop with coverage", i: "_frac_adult_of_pop_with_coverage", x: 99 }, { n: "initial adult population", i: "_initial_adult_population", x: 100 }, { n: "initial population at risk of developing NCD", i: "_initial_population_at_risk_of_developing_ncd", x: 101 }, { n: "Population at risk of developing NCD", i: "_population_at_risk_of_developing_ncd", x: 102 }, { n: "initial prevalent NCD", i: "_initial_prevalent_ncd", x: 103 }, { n: "initial undiagnosed uncontrolled NCD", i: "_initial_undiagnosed_uncontrolled_ncd", x: 104 }, { n: "Untreated NCD", i: "_untreated_ncd", x: 105 }, { n: "strategy to increase provider productivity", i: "_strategy_to_increase_provider_productivity", x: 106 }, { n: "provider productivity", i: "_provider_productivity", x: 107 }, { n: "annual clinical minutes per provider", i: "_annual_clinical_minutes_per_provider", x: 108 }, { n: "Total Providers", i: "_total_providers", x: 109 }, { n: "total provider minutes", i: "_total_provider_minutes", x: 110 }, { n: "initial total demand minutes", i: "_initial_total_demand_minutes", x: 111 }, { n: "total demand minutes", i: "_total_demand_minutes", x: 112 }, { n: "demand fulfilment ratio", i: "_demand_fulfilment_ratio", x: 113 }, { n: "initial health insurance coverage rate", i: "_initial_health_insurance_coverage_rate", x: 114 }, { n: "relative coverage rate", i: "_relative_coverage_rate", x: 115 }, { n: "eff of health coverage on screening", i: "_eff_of_health_coverage_on_screening", x: 116 }, { n: "screening promotion strategy", i: "_screening_promotion_strategy", x: 117 }, { n: "implied screening propensity", i: "_implied_screening_propensity", x: 118 }, { n: "NCD screen rate", i: "_ncd_screen_rate", x: 119 }, { n: "people screened for NCD", i: "_people_screened_for_ncd", x: 120 }, { n: "new utilization for HTN screen", i: "_new_utilization_for_htn_screen", x: 121 }, { n: "new utilization for DIA screen", i: "_new_utilization_for_dia_screen", x: 122 }, { n: "NCD screening related service utilization", i: "_ncd_screening_related_service_utilization", x: 123 }, { n: "initial diagnosed not controlled NCD", i: "_initial_diagnosed_not_controlled_ncd", x: 124 }, { n: "Treated NCD", i: "_treated_ncd", x: 125 }, { n: "population in HTN treatment", i: "_population_in_htn_treatment", x: 126 }, { n: "population in DIA treatment", i: "_population_in_dia_treatment", x: 127 }, { n: "active patient NCD related service utilization", i: "_active_patient_ncd_related_service_utilization", x: 128 }, { n: "NCD related service utilization", i: "_ncd_related_service_utilization", x: 129 }, { n: "NCD related service utilization per capita", i: "_ncd_related_service_utilization_per_capita", x: 130 }, { n: "care capacity per capita", i: "_care_capacity_per_capita", x: 131 }, { n: "initial care capacity per capita", i: "_initial_care_capacity_per_capita", x: 132 }, { n: "access multiplier", i: "_access_multiplier", x: 133 }, { n: "other health service utilization", i: "_other_health_service_utilization", x: 134 }, { n: "uninsured service utilization per capita", i: "_uninsured_service_utilization_per_capita", x: 135 }, { n: "uninsured patient visits", i: "_uninsured_patient_visits", x: 136 }, { n: "revenue from user fees", i: "_revenue_from_user_fees", x: 137 }, { n: "strategy to decrease reimbursement delay", i: "_strategy_to_decrease_reimbursement_delay", x: 138 }, { n: "implied delay", i: "_implied_delay", x: 139 }, { n: "CBHI revenue", i: "_cbhi_revenue", x: 140 }, { n: "strategy to increase reimbursement", i: "_strategy_to_increase_reimbursement", x: 141 }, { n: "CBHI reimbursement approval fraction DATA", i: "_cbhi_reimbursement_approval_fraction_data", x: 142 }, { n: "implied CBHI reimbursement approval fraction", i: "_implied_cbhi_reimbursement_approval_fraction", x: 143 }, { n: "adult pop with coverage", i: "_adult_pop_with_coverage", x: 144 }, { n: "insured service utilization per capita", i: "_insured_service_utilization_per_capita", x: 145 }, { n: "CBHI or fee waivered patient visits", i: "_cbhi_or_fee_waivered_patient_visits", x: 146 }, { n: "reimbursement requests from CBHIs", i: "_reimbursement_requests_from_cbhis", x: 147 }, { n: "CBHI reimbursements approved", i: "_cbhi_reimbursements_approved", x: 148 }, { n: "CBHI paid", i: "_cbhi_paid", x: 149 }, { n: "reimbursements", i: "_reimbursements", x: 150 }, { n: "total internal revenue", i: "_total_internal_revenue", x: 151 }, { n: "utilized internal revenue", i: "_utilized_internal_revenue", x: 152 }, { n: "strategy to divert unutilized revenue", i: "_strategy_to_divert_unutilized_revenue", x: 153 }, { n: "unutilized internal revenue", i: "_unutilized_internal_revenue", x: 154 }, { n: "DATA adjusted total revolving drug funds", i: "_data_adjusted_total_revolving_drug_funds", x: 155 }, { n: "avg adjusted total revolving drug funds", i: "_avg_adjusted_total_revolving_drug_funds", x: 156 }, { n: "unutilized internal revenue per facility", i: "_unutilized_internal_revenue_per_facility", x: 157 }, { n: "adjusted annual average RDF", i: "_adjusted_annual_average_rdf", x: 158 }, { n: "initial avg adjusted total revolving drug funds", i: "_initial_avg_adjusted_total_revolving_drug_funds", x: 159 }, { n: "total NCD care demand pop", i: "_total_ncd_care_demand_pop", x: 160 }, { n: "initial demand for medications", i: "_initial_demand_for_medications", x: 161 }, { n: "Fraction in treatment", i: "_fraction_in_treatment", x: 162 }, { n: "fraction not in treatment", i: "_fraction_not_in_treatment", x: 163 }, { n: "initial fraction not in treatment", i: "_initial_fraction_not_in_treatment", x: 164 }, { n: "initial CBHI eligible not enrolled", i: "_initial_cbhi_eligible_not_enrolled", x: 165 }, { n: "People in informal sector not enrolled to CBHI", i: "_people_in_informal_sector_not_enrolled_to_cbhi", x: 166 }, { n: "percent enrolled in CBHI", i: "_percent_enrolled_in_cbhi", x: 167 }, { n: "initial perceived benefit", i: "_initial_perceived_benefit", x: 168 }, { n: "SAVEPER", i: "_saveper", x: 169 }, { n: "death of at risk population", i: "_death_of_at_risk_population", x: 170 }, { n: "developing NCD", i: "_developing_ncd", x: 171 }, { n: "dropout", i: "_dropout", x: 172 }, { n: "fee waiver enrollment change", i: "_fee_waiver_enrollment_change", x: 173 }, { n: "new people joining at risk population", i: "_new_people_joining_at_risk_population", x: 174 }, { n: "total visits", i: "_total_visits", x: 175 }, { n: "total service utilization per capita", i: "_total_service_utilization_per_capita", x: 176 }, { n: "change in demand for medications", i: "_change_in_demand_for_medications", x: 177 }, { n: "implied medication utilization rate", i: "_implied_medication_utilization_rate", x: 178 }, { n: "stock out rate", i: "_stock_out_rate", x: 179 }, { n: "strategy to increase restocking", i: "_strategy_to_increase_restocking", x: 180 }, { n: "strategy to increase demand responsiveness", i: "_strategy_to_increase_demand_responsiveness", x: 181 }, { n: "implied procurement responsiveness", i: "_implied_procurement_responsiveness", x: 182 }, { n: "relative avg adjusted total revolving drug funds", i: "_relative_avg_adjusted_total_revolving_drug_funds", x: 183 }, { n: "implied medication restocking", i: "_implied_medication_restocking", x: 184 }, { n: "restocking rate", i: "_restocking_rate", x: 185 }, { n: "essential medication availability", i: "_essential_medication_availability", x: 186 }, { n: "provider per facility", i: "_provider_per_facility", x: 187 }, { n: "strategy to increase enrollments", i: "_strategy_to_increase_enrollments", x: 188 }, { n: "relative benefit", i: "_relative_benefit", x: 189 }, { n: "eff of perceived benefit on enrollment", i: "_eff_of_perceived_benefit_on_enrollment", x: 190 }, { n: "implied enrollment rate", i: "_implied_enrollment_rate", x: 191 }, { n: "new enrollments", i: "_new_enrollments", x: 192 }, { n: "relative untreated NCD", i: "_relative_untreated_ncd", x: 193 }, { n: "implied positive screening rate", i: "_implied_positive_screening_rate", x: 194 }, { n: "people screened positive for NCD", i: "_people_screened_positive_for_ncd", x: 195 }, { n: "relative essential medication availability", i: "_relative_essential_medication_availability", x: 196 }, { n: "implied tx enrollment frac post screening", i: "_implied_tx_enrollment_frac_post_screening", x: 197 }, { n: "new enrollment into care", i: "_new_enrollment_into_care", x: 198 }, { n: "strategy to increase provider capacity", i: "_strategy_to_increase_provider_capacity", x: 199 }, { n: "max provider per facility", i: "_max_provider_per_facility", x: 200 }, { n: "provider gap", i: "_provider_gap", x: 201 }, { n: "net change in provider availability", i: "_net_change_in_provider_availability", x: 202 }, { n: "strategy to increase fee waivers", i: "_strategy_to_increase_fee_waivers", x: 203 }, { n: "fee waivered insurance coverage", i: "_fee_waivered_insurance_coverage", x: 204 }, { n: "implied eligible households not enrolled", i: "_implied_eligible_households_not_enrolled", x: 205 }, { n: "eligible population adjustment", i: "_eligible_population_adjustment", x: 206 }, { n: "implied discontinuation rate", i: "_implied_discontinuation_rate", x: 207 }, { n: "discontinuation from care", i: "_discontinuation_from_care", x: 208 }, { n: "minutes per non NCD visit", i: "_minutes_per_non_ncd_visit", x: 209 }, { n: "non NCD visits", i: "_non_ncd_visits", x: 210 }, { n: "demand minutes for non NCD", i: "_demand_minutes_for_non_ncd", x: 211 }, { n: "demand minutes for NCD screening", i: "_demand_minutes_for_ncd_screening", x: 212 }, { n: "minutes per NCD patient year", i: "_minutes_per_ncd_patient_year", x: 213 }, { n: "demand minutes for NCD", i: "_demand_minutes_for_ncd", x: 214 }, { n: "death rate for untreated NCD", i: "_death_rate_for_untreated_ncd", x: 215 }, { n: "death of untreated NCD patients", i: "_death_of_untreated_ncd_patients", x: 216 }, { n: "ocm rate for treated", i: "_ocm_rate_for_treated", x: 217 }, { n: "death of treated NCD patients", i: "_death_of_treated_ncd_patients", x: 218 }, { n: "DATA adjusted membership cost per household", i: "_data_adjusted_membership_cost_per_household", x: 219 }, { n: "adjusted total CBHI collected fees", i: "_adjusted_total_cbhi_collected_fees", x: 220 }, { n: "adjusted subsidies", i: "_adjusted_subsidies", x: 221 }, { n: "collected fees and subsidies", i: "_collected_fees_and_subsidies", x: 222 }], varTypes: ["const", "data", "aux", "level", "initial"], varInstances: { constants: [[0, 0], [0, 1], [0, 2, 0, 1], [0, 2, 1, 0], [0, 3], [0, 4], [0, 5], [0, 6], [0, 7], [0, 8], [0, 9], [0, 10, 0, 1], [0, 10, 1, 0], [0, 11], [0, 12], [0, 13], [0, 14], [0, 15], [0, 16], [0, 17, 0, 1], [0, 17, 1, 0], [0, 18], [0, 19, 0, 1], [0, 19, 1, 0], [0, 20], [0, 21], [0, 22], [0, 23], [0, 24], [0, 25, 0, 1], [0, 25, 1, 0], [0, 26], [0, 27], [0, 28], [0, 29], [0, 30], [0, 31], [0, 32], [0, 33], [0, 34], [0, 35], [0, 36], [0, 37], [0, 38], [0, 39], [0, 40], [0, 41], [0, 42, 0, 1], [0, 42, 1, 0], [0, 43, 0, 1], [0, 43, 1, 0], [0, 44], [0, 45], [0, 46], [0, 47], [0, 48], [0, 49], [0, 50], [0, 51], [0, 52], [0, 53], [0, 54], [0, 55], [0, 56], [0, 57], [0, 58], [0, 59], [0, 60, 0, 1], [0, 60, 1, 0], [0, 61], [0, 62], [0, 63], [0, 64], [0, 65], [0, 66], [0, 67], [0, 68, 0, 1], [0, 68, 1, 0], [0, 69, 0, 1], [0, 69, 1, 0], [0, 70, 0, 1], [0, 70, 1, 0], [0, 71], [0, 72], [0, 73], [0, 74], [0, 75], [0, 76, 0, 1], [0, 76, 1, 0], [0, 77], [0, 78]], lookupVars: [], dataVars: [[1, 79], [1, 80], [1, 81], [1, 82], [1, 83], [1, 84], [1, 85], [1, 86], [1, 87]], initVars: [[2, 88], [2, 89], [2, 90], [2, 91], [3, 92], [2, 93], [3, 94], [3, 95], [3, 96], [2, 97], [2, 98], [4, 99, 1, 0], [4, 99, 0, 1], [2, 100, 1, 0], [3, 101, 1, 0], [2, 102, 1, 0], [2, 103, 1, 0], [3, 104, 1, 0], [2, 105], [2, 106], [2, 107], [3, 108], [2, 109], [2, 110], [2, 111], [2, 112], [4, 113], [2, 114], [2, 115, 1, 0], [2, 116], [2, 117, 1, 0], [2, 118, 1, 0], [2, 119, 1, 0], [2, 120], [2, 100, 0, 1], [3, 101, 0, 1], [2, 102, 0, 1], [2, 103, 0, 1], [3, 104, 0, 1], [2, 115, 0, 1], [2, 117, 0, 1], [2, 118, 0, 1], [2, 119, 0, 1], [2, 121], [2, 122], [2, 123, 1, 0], [3, 124, 1, 0], [2, 125], [2, 123, 0, 1], [3, 124, 0, 1], [2, 126], [2, 127], [2, 128], [2, 129], [2, 130], [4, 131], [2, 132], [2, 133], [2, 134], [2, 135], [2, 136], [2, 137], [2, 138], [3, 139], [2, 140], [2, 141], [2, 142], [2, 143], [2, 144], [2, 145], [2, 146], [2, 147], [2, 148], [2, 149], [2, 150], [2, 151], [2, 152], [2, 153], [2, 154], [2, 155], [2, 156], [2, 157], [4, 158], [2, 159], [4, 160], [2, 161, 0, 1], [2, 162, 0, 1], [4, 163, 0, 1], [2, 161, 1, 0], [2, 162, 1, 0], [4, 163, 1, 0], [2, 164], [3, 165], [2, 166], [4, 167]], levelVars: [[3, 96], [3, 139], [3, 92], [3, 94], [3, 95], [3, 165], [3, 101, 0, 1], [3, 101, 1, 0], [3, 108], [3, 124, 0, 1], [3, 124, 1, 0], [3, 104, 0, 1], [3, 104, 1, 0]], auxVars: [[2, 168], [2, 169, 0, 1], [2, 169, 1, 0], [2, 170, 0, 1], [2, 170, 1, 0], [2, 171], [2, 172], [2, 88], [2, 164], [2, 100, 0, 1], [2, 100, 1, 0], [2, 173], [2, 152], [2, 97], [2, 98], [2, 111], [2, 105], [2, 106], [2, 107], [2, 109], [2, 112], [2, 114], [2, 115, 1, 0], [2, 116], [2, 117, 1, 0], [2, 118, 1, 0], [2, 119, 1, 0], [2, 120], [2, 115, 0, 1], [2, 117, 0, 1], [2, 118, 0, 1], [2, 119, 0, 1], [2, 121], [2, 122], [2, 125], [2, 126], [2, 127], [2, 128], [2, 129], [2, 130], [2, 132], [2, 133], [2, 134], [2, 135], [2, 136], [2, 137], [2, 138], [2, 148], [2, 149], [2, 150], [2, 151], [2, 153], [2, 143], [2, 144], [2, 145], [2, 174], [2, 175], [2, 159], [2, 176], [2, 177], [2, 178], [2, 179], [2, 180], [2, 181], [2, 154], [2, 155], [2, 156], [2, 157], [2, 182], [2, 183], [2, 184], [2, 185], [2, 166], [2, 186], [2, 187], [2, 188], [2, 189], [2, 190], [2, 191], [2, 161, 1, 0], [2, 162, 1, 0], [2, 192, 1, 0], [2, 193, 1, 0], [2, 194, 1, 0], [2, 89], [2, 90], [2, 195], [2, 196, 1, 0], [2, 197, 1, 0], [2, 161, 0, 1], [2, 162, 0, 1], [2, 192, 0, 1], [2, 193, 0, 1], [2, 194, 0, 1], [2, 196, 0, 1], [2, 197, 0, 1], [2, 198], [2, 199], [2, 200], [2, 201], [2, 102, 1, 0], [2, 103, 1, 0], [2, 102, 0, 1], [2, 103, 0, 1], [2, 110], [2, 93], [2, 91], [2, 123, 1, 0], [2, 123, 0, 1], [2, 140], [2, 141], [2, 202], [2, 203], [2, 204], [2, 205], [2, 206, 1, 0], [2, 207, 1, 0], [2, 206, 0, 1], [2, 207, 0, 1], [2, 208], [2, 209], [2, 210], [2, 211], [2, 212], [2, 213], [2, 214, 1, 0], [2, 215, 1, 0], [2, 214, 0, 1], [2, 215, 0, 1], [2, 216, 1, 0], [2, 217, 1, 0], [2, 216, 0, 1], [2, 217, 0, 1], [2, 218], [2, 219], [2, 220], [2, 221], [2, 142], [2, 146], [2, 147]] } }, modelSizeInBytes = 88858, dataSizeInBytes = 0, modelWorkerJs = '(function(){"use strict";var commonjsGlobal=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function getDefaultExportFromCjs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var worker={},isObservable,hasRequiredIsObservable;function requireIsObservable(){return hasRequiredIsObservable||(hasRequiredIsObservable=1,isObservable=e=>e?typeof Symbol.observable=="symbol"&&typeof e[Symbol.observable]=="function"?e===e[Symbol.observable]():typeof e["@@observable"]=="function"?e===e["@@observable"]():!1:!1),isObservable}var common={},serializers={},hasRequiredSerializers;function requireSerializers(){if(hasRequiredSerializers)return serializers;hasRequiredSerializers=1,Object.defineProperty(serializers,"__esModule",{value:!0}),serializers.DefaultSerializer=serializers.extendSerializer=void 0;function e(t,_){const r=t.deserialize.bind(t),a=t.serialize.bind(t);return{deserialize(s){return _.deserialize(s,r)},serialize(s){return _.serialize(s,a)}}}serializers.extendSerializer=e;const i={deserialize(t){return Object.assign(Error(t.message),{name:t.name,stack:t.stack})},serialize(t){return{__error_marker:"$$error",message:t.message,name:t.name,stack:t.stack}}},n=t=>t&&typeof t=="object"&&"__error_marker"in t&&t.__error_marker==="$$error";return serializers.DefaultSerializer={deserialize(t){return n(t)?i.deserialize(t):t},serialize(t){return t instanceof Error?i.serialize(t):t}},serializers}var hasRequiredCommon;function requireCommon(){if(hasRequiredCommon)return common;hasRequiredCommon=1,Object.defineProperty(common,"__esModule",{value:!0}),common.serialize=common.deserialize=common.registerSerializer=void 0;const e=requireSerializers();let i=e.DefaultSerializer;function n(r){i=e.extendSerializer(i,r)}common.registerSerializer=n;function t(r){return i.deserialize(r)}common.deserialize=t;function _(r){return i.serialize(r)}return common.serialize=_,common}var transferable={},symbols={},hasRequiredSymbols;function requireSymbols(){return hasRequiredSymbols||(hasRequiredSymbols=1,Object.defineProperty(symbols,"__esModule",{value:!0}),symbols.$worker=symbols.$transferable=symbols.$terminate=symbols.$events=symbols.$errors=void 0,symbols.$errors=Symbol("thread.errors"),symbols.$events=Symbol("thread.events"),symbols.$terminate=Symbol("thread.terminate"),symbols.$transferable=Symbol("thread.transferable"),symbols.$worker=Symbol("thread.worker")),symbols}var hasRequiredTransferable;function requireTransferable(){if(hasRequiredTransferable)return transferable;hasRequiredTransferable=1,Object.defineProperty(transferable,"__esModule",{value:!0}),transferable.Transfer=transferable.isTransferDescriptor=void 0;const e=requireSymbols();function i(_){return!(!_||typeof _!="object")}function n(_){return _&&typeof _=="object"&&_[e.$transferable]}transferable.isTransferDescriptor=n;function t(_,r){if(!r){if(!i(_))throw Error();r=[_]}return{[e.$transferable]:!0,send:_,transferables:r}}return transferable.Transfer=t,transferable}var messages={},hasRequiredMessages;function requireMessages(){return hasRequiredMessages||(hasRequiredMessages=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.WorkerMessageType=e.MasterMessageType=void 0,(function(i){i.cancel="cancel",i.run="run"})(e.MasterMessageType||(e.MasterMessageType={})),(function(i){i.error="error",i.init="init",i.result="result",i.running="running",i.uncaughtError="uncaughtError"})(e.WorkerMessageType||(e.WorkerMessageType={}))})(messages)),messages}var implementation={},implementation_browser={},hasRequiredImplementation_browser;function requireImplementation_browser(){if(hasRequiredImplementation_browser)return implementation_browser;hasRequiredImplementation_browser=1,Object.defineProperty(implementation_browser,"__esModule",{value:!0});const e=function(){const _=typeof self<"u"&&typeof Window<"u"&&self instanceof Window;return!!(typeof self<"u"&&self.postMessage&&!_)},i=function(_,r){self.postMessage(_,r)},n=function(_){const r=s=>{_(s.data)},a=()=>{self.removeEventListener("message",r)};return self.addEventListener("message",r),a};return implementation_browser.default={isWorkerRuntime:e,postMessageToMaster:i,subscribeToMasterMessages:n},implementation_browser}var implementation_tinyWorker={},hasRequiredImplementation_tinyWorker;function requireImplementation_tinyWorker(){if(hasRequiredImplementation_tinyWorker)return implementation_tinyWorker;hasRequiredImplementation_tinyWorker=1,Object.defineProperty(implementation_tinyWorker,"__esModule",{value:!0}),typeof self>"u"&&(commonjsGlobal.self=commonjsGlobal);const e=function(){return!!(typeof self<"u"&&self.postMessage)},i=function(a){self.postMessage(a)};let n=!1;const t=new Set,_=function(a){return n||(self.addEventListener("message",(d=>{t.forEach(l=>l(d.data))})),n=!0),t.add(a),()=>t.delete(a)};return implementation_tinyWorker.default={isWorkerRuntime:e,postMessageToMaster:i,subscribeToMasterMessages:_},implementation_tinyWorker}var implementation_worker_threads={},worker_threads={},hasRequiredWorker_threads;function requireWorker_threads(){if(hasRequiredWorker_threads)return worker_threads;hasRequiredWorker_threads=1,Object.defineProperty(worker_threads,"__esModule",{value:!0});let implementation;function selectImplementation(){return typeof __non_webpack_require__=="function"?__non_webpack_require__("worker_threads"):eval("require")("worker_threads")}function getImplementation(){return implementation||(implementation=selectImplementation()),implementation}return worker_threads.default=getImplementation,worker_threads}var hasRequiredImplementation_worker_threads;function requireImplementation_worker_threads(){if(hasRequiredImplementation_worker_threads)return implementation_worker_threads;hasRequiredImplementation_worker_threads=1;var e=implementation_worker_threads&&implementation_worker_threads.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(implementation_worker_threads,"__esModule",{value:!0});const i=e(requireWorker_threads());function n(s){if(!s)throw Error("Invariant violation: MessagePort to parent is not available.");return s}const t=function(){return!i.default().isMainThread},_=function(d,l){n(i.default().parentPort).postMessage(d,l)},r=function(d){const l=i.default().parentPort;if(!l)throw Error("Invariant violation: MessagePort to parent is not available.");const p=f=>{d(f)},v=()=>{n(l).off("message",p)};return n(l).on("message",p),v};function a(){i.default()}return implementation_worker_threads.default={isWorkerRuntime:t,postMessageToMaster:_,subscribeToMasterMessages:r,testImplementation:a},implementation_worker_threads}var hasRequiredImplementation;function requireImplementation(){if(hasRequiredImplementation)return implementation;hasRequiredImplementation=1;var e=implementation&&implementation.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(implementation,"__esModule",{value:!0});const i=e(requireImplementation_browser()),n=e(requireImplementation_tinyWorker()),t=e(requireImplementation_worker_threads()),_=typeof process<"u"&&process.arch!=="browser"&&"pid"in process;function r(){try{return t.default.testImplementation(),t.default}catch{return n.default}}return implementation.default=_?r():i.default,implementation}var hasRequiredWorker;function requireWorker(){return hasRequiredWorker||(hasRequiredWorker=1,(function(e){var i=worker&&worker.__awaiter||function(o,c,u,b){function L(E){return E instanceof u?E:new u(function(B){B(E)})}return new(u||(u=Promise))(function(E,B){function R(P){try{D(b.next(P))}catch(N){B(N)}}function q(P){try{D(b.throw(P))}catch(N){B(N)}}function D(P){P.done?E(P.value):L(P.value).then(R,q)}D((b=b.apply(o,c||[])).next())})},n=worker&&worker.__importDefault||function(o){return o&&o.__esModule?o:{default:o}};Object.defineProperty(e,"__esModule",{value:!0}),e.expose=e.isWorkerRuntime=e.Transfer=e.registerSerializer=void 0;const t=n(requireIsObservable()),_=requireCommon(),r=requireTransferable(),a=requireMessages(),s=n(requireImplementation());var d=requireCommon();Object.defineProperty(e,"registerSerializer",{enumerable:!0,get:function(){return d.registerSerializer}});var l=requireTransferable();Object.defineProperty(e,"Transfer",{enumerable:!0,get:function(){return l.Transfer}}),e.isWorkerRuntime=s.default.isWorkerRuntime;let p=!1;const v=new Map,f=o=>o&&o.type===a.MasterMessageType.cancel,M=o=>o&&o.type===a.MasterMessageType.run,z=o=>t.default(o)||T(o);function T(o){return o&&typeof o=="object"&&typeof o.subscribe=="function"}function k(o){return r.isTransferDescriptor(o)?{payload:o.send,transferables:o.transferables}:{payload:o,transferables:void 0}}function S(){const o={type:a.WorkerMessageType.init,exposed:{type:"function"}};s.default.postMessageToMaster(o)}function O(o){const c={type:a.WorkerMessageType.init,exposed:{type:"module",methods:o}};s.default.postMessageToMaster(c)}function w(o,c){const{payload:u,transferables:b}=k(c),L={type:a.WorkerMessageType.error,uid:o,error:_.serialize(u)};s.default.postMessageToMaster(L,b)}function h(o,c,u){const{payload:b,transferables:L}=k(u),E={type:a.WorkerMessageType.result,uid:o,complete:c?!0:void 0,payload:b};s.default.postMessageToMaster(E,L)}function y(o,c){const u={type:a.WorkerMessageType.running,uid:o,resultType:c};s.default.postMessageToMaster(u)}function I(o){try{const c={type:a.WorkerMessageType.uncaughtError,error:_.serialize(o)};s.default.postMessageToMaster(c)}catch(c){console.error(`Not reporting uncaught error back to master thread as it occured while reporting an uncaught error already.\nLatest error:`,c,`\nOriginal error:`,o)}}function g(o,c,u){return i(this,void 0,void 0,function*(){let b;try{b=c(...u)}catch(E){return w(o,E)}const L=z(b)?"observable":"promise";if(y(o,L),z(b)){const E=b.subscribe(B=>h(o,!1,_.serialize(B)),B=>{w(o,_.serialize(B)),v.delete(o)},()=>{h(o,!0),v.delete(o)});v.set(o,E)}else try{const E=yield b;h(o,!0,_.serialize(E))}catch(E){w(o,_.serialize(E))}})}function m(o){if(!s.default.isWorkerRuntime())throw Error("expose() called in the master thread.");if(p)throw Error("expose() called more than once. This is not possible. Pass an object to expose() if you want to expose multiple functions.");if(p=!0,typeof o=="function")s.default.subscribeToMasterMessages(c=>{M(c)&&!c.method&&g(c.uid,o,c.args.map(_.deserialize))}),S();else if(typeof o=="object"&&o){s.default.subscribeToMasterMessages(u=>{M(u)&&u.method&&g(u.uid,o[u.method],u.args.map(_.deserialize))});const c=Object.keys(o).filter(u=>typeof o[u]=="function");O(c)}else throw Error(`Invalid argument passed to expose(). Expected a function or an object, got: ${o}`);s.default.subscribeToMasterMessages(c=>{if(f(c)){const u=c.uid,b=v.get(u);b&&(b.unsubscribe(),v.delete(u))}})}e.expose=m,typeof self<"u"&&typeof self.addEventListener=="function"&&s.default.isWorkerRuntime()&&(self.addEventListener("error",o=>{setTimeout(()=>I(o.error||o),250)}),self.addEventListener("unhandledrejection",o=>{const c=o.reason;c&&typeof c.message=="string"&&setTimeout(()=>I(c),250)})),typeof process<"u"&&typeof process.on=="function"&&s.default.isWorkerRuntime()&&(process.on("uncaughtException",o=>{setTimeout(()=>I(o),250)}),process.on("unhandledRejection",o=>{o&&typeof o.message=="string"&&setTimeout(()=>I(o),250)}))})(worker)),worker}var workerExports=requireWorker();const WorkerContext=getDefaultExportFromCjs(workerExports),expose=WorkerContext.expose;WorkerContext.registerSerializer;const Transfer=WorkerContext.Transfer;function getEncodedVarIndicesLength(e){var i;let n=1;for(const t of e){n+=2;const _=((i=t.subscriptIndices)==null?void 0:i.length)||0;n+=_}return n}function encodeVarIndices(e,i){let n=0;i[n++]=e.length;for(const t of e){i[n++]=t.varIndex;const _=t.subscriptIndices,r=_?.length||0;i[n++]=r;for(let a=0;a<r;a++)i[n++]=_[a]}}function getEncodedConstantBufferLengths(e){var i;let n=1,t=0;for(const _ of e){const r=_.varRef.varSpec;if(r===void 0)throw new Error("Cannot compute constant buffer lengths until all constant var specs are defined");n+=2;const a=((i=r.subscriptIndices)==null?void 0:i.length)||0;n+=a,t+=1}return{constantIndicesLength:n,constantsLength:t}}function encodeConstants(e,i,n){let t=0;i[t++]=e.length;let _=0;for(const r of e){const a=r.varRef.varSpec;i[t++]=a.varIndex;const s=a.subscriptIndices,d=s?.length||0;i[t++]=d;for(let l=0;l<d;l++)i[t++]=s[l];n[_++]=r.value}}function decodeConstants(e,i){const n=[];let t=0;const _=e[t++];for(let r=0;r<_;r++){const a=e[t++],s=e[t++],d=s>0?Array(s):void 0;for(let v=0;v<s;v++)d[v]=e[t++];const l={varIndex:a,subscriptIndices:d},p=i[r];n.push({varRef:{varSpec:l},value:p})}return n}function getEncodedLookupBufferLengths(e){var i,n;let t=1,_=0;for(const r of e){const a=r.varRef.varSpec;if(a===void 0)throw new Error("Cannot compute lookup buffer lengths until all lookup var specs are defined");t+=2;const s=((i=a.subscriptIndices)==null?void 0:i.length)||0;t+=s,t+=2,_+=((n=r.points)==null?void 0:n.length)||0}return{lookupIndicesLength:t,lookupsLength:_}}function encodeLookups(e,i,n){let t=0;i[t++]=e.length;let _=0;for(const r of e){const a=r.varRef.varSpec;i[t++]=a.varIndex;const s=a.subscriptIndices,d=s?.length||0;i[t++]=d;for(let l=0;l<d;l++)i[t++]=s[l];r.points!==void 0?(i[t++]=_,i[t++]=r.points.length,n?.set(r.points,_),_+=r.points.length):(i[t++]=-1,i[t++]=0)}}function decodeLookups(e,i){const n=[];let t=0;const _=e[t++];for(let r=0;r<_;r++){const a=e[t++],s=e[t++],d=s>0?Array(s):void 0;for(let M=0;M<s;M++)d[M]=e[t++];const l=e[t++],p=e[t++],v={varIndex:a,subscriptIndices:d};let f;l>=0?i?f=i.slice(l,l+p):f=new Float64Array(0):f=void 0,n.push({varRef:{varSpec:v},points:f})}return n}function resolveVarRef(e,i,n){if(!i.varSpec){if(e===void 0)throw new Error(`Unable to resolve ${n} variable references by name or identifier when model listing is unavailable`);if(i.varId){const t=e?.getSpecForVarId(i.varId);if(t)i.varSpec=t;else throw new Error(`Failed to resolve ${n} variable reference for varId=${i.varId}`)}else{const t=e?.getSpecForVarName(i.varName);if(t)i.varSpec=t;else throw new Error(`Failed to resolve ${n} variable reference for varName=\'${i.varId}\'`)}}}var headerLengthInElements=20,extrasLengthInElements=1,Int32Section=class{constructor(){this.offsetInBytes=0,this.lengthInElements=0}update(e,i,n){this.view=n>0?new Int32Array(e,i,n):void 0,this.offsetInBytes=i,this.lengthInElements=n}},Float64Section=class{constructor(){this.offsetInBytes=0,this.lengthInElements=0}update(e,i,n){this.view=n>0?new Float64Array(e,i,n):void 0,this.offsetInBytes=i,this.lengthInElements=n}},BufferedRunModelParams=class{constructor(e){this.listing=e,this.header=new Int32Section,this.extras=new Float64Section,this.inputs=new Float64Section,this.outputs=new Float64Section,this.outputIndices=new Int32Section,this.constants=new Float64Section,this.constantIndices=new Int32Section,this.lookups=new Float64Section,this.lookupIndices=new Int32Section}getEncodedBuffer(){return this.encoded}getInputs(){return this.inputs.view}copyInputs(e,i){this.inputs.lengthInElements!==0&&((e===void 0||e.length<this.inputs.lengthInElements)&&(e=i(this.inputs.lengthInElements)),e.set(this.inputs.view))}getOutputIndicesLength(){return this.outputIndices.lengthInElements}getOutputIndices(){return this.outputIndices.view}copyOutputIndices(e,i){this.outputIndices.lengthInElements!==0&&((e===void 0||e.length<this.outputIndices.lengthInElements)&&(e=i(this.outputIndices.lengthInElements)),e.set(this.outputIndices.view))}getOutputsLength(){return this.outputs.lengthInElements}getOutputs(){return this.outputs.view}getOutputsObject(){}storeOutputs(e){this.outputs.view!==void 0&&(e.length>this.outputs.view.length?this.outputs.view.set(e.subarray(0,this.outputs.view.length)):this.outputs.view.set(e))}getConstants(){if(this.constantIndices.lengthInElements!==0)return decodeConstants(this.constantIndices.view,this.constants.view)}getLookups(){if(this.lookupIndices.lengthInElements!==0)return decodeLookups(this.lookupIndices.view,this.lookups.view)}getElapsedTime(){return this.extras.view[0]}storeElapsedTime(e){this.extras.view[0]=e}finalizeOutputs(e){this.outputs.view&&e.updateFromBuffer(this.outputs.view,e.seriesLength),e.runTimeInMillis=this.getElapsedTime()}updateFromParams(e,i,n){const t=e.length,_=i.varIds.length*i.seriesLength;let r;const a=i.varSpecs;a!==void 0&&a.length>0?r=getEncodedVarIndicesLength(a):r=0;let s,d;if(n?.constants!==void 0&&n.constants.length>0){for(const u of n.constants)resolveVarRef(this.listing,u.varRef,"constant");const c=getEncodedConstantBufferLengths(n.constants);s=c.constantsLength,d=c.constantIndicesLength}else s=0,d=0;let l,p;if(n?.lookups!==void 0&&n.lookups.length>0){for(const u of n.lookups)resolveVarRef(this.listing,u.varRef,"lookup");const c=getEncodedLookupBufferLengths(n.lookups);l=c.lookupsLength,p=c.lookupIndicesLength}else l=0,p=0;let v=0;function f(c,u){const b=v,L=c==="float64"?Float64Array.BYTES_PER_ELEMENT:Int32Array.BYTES_PER_ELEMENT,E=Math.round(u*L),B=Math.ceil(E/8)*8;return v+=B,b}const M=f("int32",headerLengthInElements),z=f("float64",extrasLengthInElements),T=f("float64",t),k=f("float64",_),S=f("int32",r),O=f("float64",s),w=f("int32",d),h=f("float64",l),y=f("int32",p),I=v;if(this.encoded===void 0||this.encoded.byteLength<I){const c=Math.ceil(I*1.2);this.encoded=new ArrayBuffer(c),this.header.update(this.encoded,M,headerLengthInElements)}const g=this.header.view;let m=0;g[m++]=z,g[m++]=extrasLengthInElements,g[m++]=T,g[m++]=t,g[m++]=k,g[m++]=_,g[m++]=S,g[m++]=r,g[m++]=O,g[m++]=s,g[m++]=w,g[m++]=d,g[m++]=h,g[m++]=l,g[m++]=y,g[m++]=p,this.inputs.update(this.encoded,T,t),this.extras.update(this.encoded,z,extrasLengthInElements),this.outputs.update(this.encoded,k,_),this.outputIndices.update(this.encoded,S,r),this.constants.update(this.encoded,O,s),this.constantIndices.update(this.encoded,w,d),this.lookups.update(this.encoded,h,l),this.lookupIndices.update(this.encoded,y,p);const o=this.inputs.view;for(let c=0;c<e.length;c++){const u=e[c];typeof u=="number"?o[c]=u:o[c]=u.get()}this.outputIndices.view&&encodeVarIndices(a,this.outputIndices.view),d>0&&encodeConstants(n.constants,this.constantIndices.view,this.constants.view),p>0&&encodeLookups(n.lookups,this.lookupIndices.view,this.lookups.view)}updateFromEncodedBuffer(e){const i=headerLengthInElements*Int32Array.BYTES_PER_ELEMENT;if(e.byteLength<i)throw new Error("Buffer must be long enough to contain header section");this.encoded=e,this.header.update(this.encoded,0,headerLengthInElements);const t=this.header.view;let _=0;const r=t[_++],a=t[_++],s=t[_++],d=t[_++],l=t[_++],p=t[_++],v=t[_++],f=t[_++],M=t[_++],z=t[_++],T=t[_++],k=t[_++],S=t[_++],O=t[_++],w=t[_++],h=t[_++],y=a*Float64Array.BYTES_PER_ELEMENT,I=d*Float64Array.BYTES_PER_ELEMENT,g=p*Float64Array.BYTES_PER_ELEMENT,m=f*Int32Array.BYTES_PER_ELEMENT,o=z*Float64Array.BYTES_PER_ELEMENT,c=k*Int32Array.BYTES_PER_ELEMENT,u=O*Float64Array.BYTES_PER_ELEMENT,b=h*Int32Array.BYTES_PER_ELEMENT,L=i+y+I+g+m+o+c+u+b;if(e.byteLength<L)throw new Error("Buffer must be long enough to contain sections declared in header");this.extras.update(this.encoded,r,a),this.inputs.update(this.encoded,s,d),this.outputs.update(this.encoded,l,p),this.outputIndices.update(this.encoded,v,f),this.constants.update(this.encoded,M,z),this.constantIndices.update(this.encoded,T,k),this.lookups.update(this.encoded,S,O),this.lookupIndices.update(this.encoded,w,h)}},_NA_=-Number.MAX_VALUE,JsModelLookup=class{constructor(e,i){if(i&&i.length<e*2)throw new Error(`Lookup data array length must be >= 2*size (length=${i.length} size=${e}`);this.originalData=i,this.originalSize=e,this.dynamicData=void 0,this.dynamicSize=0,this.activeData=this.originalData,this.activeSize=this.originalSize,this.lastInput=Number.MAX_VALUE,this.lastHitIndex=0}setData(e,i){if(i){if(i.length<e*2)throw new Error(`Lookup data array length must be >= 2*size (length=${i.length} size=${e}`);const n=e*2;if((this.dynamicData===void 0||n>this.dynamicData.length)&&(this.dynamicData=new Float64Array(n)),this.dynamicSize=e,e>0){const t=i.subarray(0,n);this.dynamicData.set(t)}this.activeData=this.dynamicData,this.activeSize=this.dynamicSize}else this.activeData=this.originalData,this.activeSize=this.originalSize;this.invertedData=void 0,this.lastInput=Number.MAX_VALUE,this.lastHitIndex=0}getValueForX(e,i){return this.getValue(e,!1,i)}getValueForY(e){if(this.invertedData===void 0){const i=this.activeSize*2,n=this.activeData,t=Array(i);for(let _=0;_<i;_+=2)t[_]=n[_+1],t[_+1]=n[_];this.invertedData=t}return this.getValue(e,!0,"interpolate")}getValue(e,i,n){if(this.activeSize===0)return _NA_;const t=i?this.invertedData:this.activeData,_=this.activeSize*2,r=!i;let a;r&&e>=this.lastInput?a=this.lastHitIndex:a=0;for(let s=a;s<_;s+=2){const d=t[s];if(d>=e){if(r&&(this.lastInput=e,this.lastHitIndex=s),s===0||d===e)return t[s+1];switch(n){default:case"interpolate":{const l=t[s-2],p=t[s-1],v=t[s+1],f=d-l,M=v-p;return p+M/f*(e-l)}case"forward":return t[s+1];case"backward":return t[s-1]}}}return r&&(this.lastInput=e,this.lastHitIndex=_),t[_-1]}getValueForGameTime(e,i){if(this.activeSize<=0)return i;const n=this.activeData[0];return e<n?i:this.getValue(e,!1,"backward")}getValueBetweenTimes(e,i){if(this.activeSize===0)return _NA_;const n=this.activeData,t=this.activeSize*2;switch(i){case"forward":{e=Math.floor(e);for(let _=0;_<t;_+=2)if(n[_]>=e)return n[_+1];return n[t-1]}case"backward":{e=Math.floor(e);for(let _=2;_<t;_+=2)if(n[_]>=e)return n[_-1];return t>=4?n[t-3]:n[1]}default:{if(e-Math.floor(e)>0){let _=`GET DATA BETWEEN TIMES was called with an input value (${e}) that has a fractional part. `;throw _+="When mode is 0 (interpolate) and the input value is not a whole number, Vensim produces unexpected ",_+="results that may differ from those produced by SDEverywhere.",new Error(_)}for(let _=2;_<t;_+=2){const r=n[_];if(r>=e){const a=n[_-2],s=n[_-1],d=n[_+1],l=r-a,p=d-s;return s+p/l*(e-a)}}return n[t-1]}}}},EPSILON=1e-6;function getJsModelFunctions(){let e;const i=new Map,n=new Map;return{setContext(t){e=t},ABS(t){return Math.abs(t)},ARCCOS(t){return Math.acos(t)},ARCSIN(t){return Math.asin(t)},ARCTAN(t){return Math.atan(t)},COS(t){return Math.cos(t)},EXP(t){return Math.exp(t)},GAME(t,_){return t?t.getValueForGameTime(e.currentTime,_):_},INTEG(t,_){return t+_*e.timeStep},INTEGER(t){return Math.trunc(t)},LN(t){return Math.log(t)},MAX(t,_){return Math.max(t,_)},MIN(t,_){return Math.min(t,_)},MODULO(t,_){return t%_},POW(t,_){return Math.pow(t,_)},POWER(t,_){return Math.pow(t,_)},PULSE(t,_){return pulse(e,t,_)},PULSE_TRAIN(t,_,r,a){const s=Math.floor((a-t)/r);for(let d=0;d<=s;d++)if(e.currentTime<=a&&pulse(e,t+d*r,_))return 1;return 0},QUANTUM(t,_){return _<=0?t:_*Math.trunc(t/_)},RAMP(t,_,r){return e.currentTime>_?e.currentTime<r||_>r?t*(e.currentTime-_):t*(r-_):0},SIN(t){return Math.sin(t)},SQRT(t){return Math.sqrt(t)},STEP(t,_){return e.currentTime+e.timeStep/2>_?t:0},TAN(t){return Math.tan(t)},VECTOR_SORT_ORDER(t,_,r){if(_>t.length)throw new Error(`VECTOR SORT ORDER input vector length (${t.length}) must be >= size (${_})`);let a=n.get(_);if(a===void 0){a=Array(_);for(let l=0;l<_;l++)a[l]={x:0,ind:0};n.set(_,a)}let s=i.get(_);s===void 0&&(s=Array(_),i.set(_,s));for(let l=0;l<_;l++)a[l].x=t[l],a[l].ind=l;const d=r>0?1:-1;a.sort((l,p)=>{let v;return l.x<p.x?v=-1:l.x>p.x?v=1:v=0,v*d});for(let l=0;l<_;l++)s[l]=a[l].ind;return s},XIDZ(t,_,r){return Math.abs(_)<EPSILON?r:t/_},ZIDZ(t,_){return Math.abs(_)<EPSILON?0:t/_},createLookup(t,_){return new JsModelLookup(t,_)},LOOKUP(t,_){return t?t.getValueForX(_,"interpolate"):_NA_},LOOKUP_FORWARD(t,_){return t?t.getValueForX(_,"forward"):_NA_},LOOKUP_BACKWARD(t,_){return t?t.getValueForX(_,"backward"):_NA_},LOOKUP_INVERT(t,_){return t?t.getValueForY(_):_NA_},WITH_LOOKUP(t,_){return _?_.getValueForX(t,"interpolate"):_NA_},GET_DATA_BETWEEN_TIMES(t,_,r){let a;return r>=1?a="forward":r<=-1?a="backward":a="interpolate",t?t.getValueBetweenTimes(_,a):_NA_}}}function pulse(e,i,n){const t=e.currentTime+e.timeStep/2;return n===0&&(n=e.timeStep),t>i&&t<i+n?1:0}var isWeb;function perfNow(){return isWeb===void 0&&(isWeb=typeof self<"u"&&self?.performance!==void 0),isWeb?self.performance.now():process==null?void 0:process.hrtime()}function perfElapsed(e){if(isWeb)return self.performance.now()-e;{const i=process.hrtime(e);return(i[0]*1e9+i[1])/1e6}}var BaseRunnableModel=class{constructor(e){this.startTime=e.startTime,this.endTime=e.endTime,this.saveFreq=e.saveFreq,this.numSavePoints=e.numSavePoints,this.outputVarIds=e.outputVarIds,this.modelListing=e.modelListing,this.onRunModel=e.onRunModel}runModel(e){var i;let n=e.getInputs();n===void 0&&(e.copyInputs(this.inputs,d=>(this.inputs=new Float64Array(d),this.inputs)),n=this.inputs);let t=e.getOutputIndices();t===void 0&&e.getOutputIndicesLength()>0&&(e.copyOutputIndices(this.outputIndices,d=>(this.outputIndices=new Int32Array(d),this.outputIndices)),t=this.outputIndices);const _=e.getOutputsLength();(this.outputs===void 0||this.outputs.length<_)&&(this.outputs=new Float64Array(_));const r=this.outputs,a=perfNow();(i=this.onRunModel)==null||i.call(this,n,r,{outputIndices:t,constants:e.getConstants(),lookups:e.getLookups()});const s=perfElapsed(a);e.storeOutputs(r),e.storeElapsedTime(s)}terminate(){}};function initJsModel(e){let i=e.getModelFunctions();i===void 0&&(i=getJsModelFunctions(),e.setModelFunctions(i));const n=e.getInitialTime(),t=e.getFinalTime(),_=e.getTimeStep(),r=e.getSaveFreq(),a=Math.round((t-n)/r)+1;return new BaseRunnableModel({startTime:n,endTime:t,saveFreq:r,numSavePoints:a,outputVarIds:e.outputVarIds,modelListing:e.modelListing,onRunModel:(s,d,l)=>{runJsModel(e,n,t,_,r,a,s,d,l?.outputIndices,l?.constants,l?.lookups)}})}function runJsModel(e,i,n,t,_,r,a,s,d,l,p,v){let f=i;e.setTime(f);const M={timeStep:t,currentTime:f};if(e.getModelFunctions().setContext(M),e.initConstants(),l!==void 0)for(const w of l)e.setConstant(w.varRef.varSpec,w.value);if(p!==void 0)for(const w of p)e.setLookup(w.varRef.varSpec,w.points);a?.length>0&&e.setInputs(w=>a[w]),e.initLevels();const z=Math.round((n-i)/t),T=n;let k=0,S=0,O=0;for(;k<=z;){if(e.evalAux(),f%_<1e-6){O=0;const w=h=>{const y=O*r+S;s[y]=f<=T?h:void 0,O++};if(d!==void 0){let h=0;const y=d[h++];for(let I=0;I<y;I++){const g=d[h++],m=d[h++];let o;m>0&&(o=d.subarray(h,h+m),h+=m);const c={varIndex:g,subscriptIndices:o};e.storeOutput(c,w)}}else e.storeOutputs(w);S++}if(k===z)break;e.evalLevels(),f+=t,e.setTime(f),M.currentTime=f,k++}}var WasmBuffer=class{constructor(e,i,n,t){this.wasmModule=e,this.numElements=i,this.byteOffset=n,this.heapArray=t}getArrayView(){return this.heapArray}getAddress(){return this.byteOffset}dispose(){var e,i;this.heapArray&&((i=(e=this.wasmModule)._free)==null||i.call(e,this.byteOffset),this.numElements=void 0,this.heapArray=void 0,this.byteOffset=void 0)}};function createInt32WasmBuffer(e,i){const t=i*4,_=e._malloc(t),r=_/4,a=e.HEAP32.subarray(r,r+i);return new WasmBuffer(e,i,_,a)}function createFloat64WasmBuffer(e,i){const t=i*8,_=e._malloc(t),r=_/8,a=e.HEAPF64.subarray(r,r+i);return new WasmBuffer(e,i,_,a)}var WasmModel=class{constructor(e){this.wasmModule=e;function i(n){return e.cwrap(n,"number",[])()}this.startTime=i("getInitialTime"),this.endTime=i("getFinalTime"),this.saveFreq=i("getSaveper"),this.numSavePoints=Math.round((this.endTime-this.startTime)/this.saveFreq)+1,this.outputVarIds=e.outputVarIds,this.modelListing=e.modelListing,this.wasmSetLookup=e.cwrap("setLookup",null,["number","number","number","number"]),this.wasmRunModel=e.cwrap("runModelWithBuffers",null,["number","number","number","number","number","number"])}runModel(e){var i,n,t,_,r,a,s,d,l,p,v;const f=e.getLookups();if(f!==void 0)for(const h of f){const y=h.varRef.varSpec,I=((i=y.subscriptIndices)==null?void 0:i.length)||0;let g;I>0?((this.lookupSubIndicesBuffer===void 0||this.lookupSubIndicesBuffer.numElements<I)&&((n=this.lookupSubIndicesBuffer)==null||n.dispose(),this.lookupSubIndicesBuffer=createInt32WasmBuffer(this.wasmModule,I)),this.lookupSubIndicesBuffer.getArrayView().set(y.subscriptIndices),g=this.lookupSubIndicesBuffer.getAddress()):g=0;let m,o;if(h.points){const u=h.points.length;(this.lookupDataBuffer===void 0||this.lookupDataBuffer.numElements<u)&&((t=this.lookupDataBuffer)==null||t.dispose(),this.lookupDataBuffer=createFloat64WasmBuffer(this.wasmModule,u)),this.lookupDataBuffer.getArrayView().set(h.points),m=this.lookupDataBuffer.getAddress(),o=u/2}else m=0,o=0;const c=y.varIndex;this.wasmSetLookup(c,g,m,o)}let M,z;const T=e.getConstants();if(T!==void 0&&T.length>0){let h=1;for(const c of T){const u=((_=c.varRef.varSpec.subscriptIndices)==null?void 0:_.length)||0;h+=2+u}(this.constantIndicesBuffer===void 0||this.constantIndicesBuffer.numElements<h)&&((r=this.constantIndicesBuffer)==null||r.dispose(),this.constantIndicesBuffer=createInt32WasmBuffer(this.wasmModule,h));const y=T.length;(this.constantValuesBuffer===void 0||this.constantValuesBuffer.numElements<y)&&((a=this.constantValuesBuffer)==null||a.dispose(),this.constantValuesBuffer=createFloat64WasmBuffer(this.wasmModule,y));const I=this.constantIndicesBuffer.getArrayView(),g=this.constantValuesBuffer.getArrayView();let m=0,o=0;I[m++]=y;for(const c of T){const u=c.varRef.varSpec,b=((s=u.subscriptIndices)==null?void 0:s.length)||0;if(I[m++]=u.varIndex,I[m++]=b,b>0)for(let L=0;L<b;L++)I[m++]=u.subscriptIndices[L];g[o++]=c.value}M=this.constantIndicesBuffer,z=this.constantValuesBuffer}else M=void 0,z=void 0;e.copyInputs((d=this.inputsBuffer)==null?void 0:d.getArrayView(),h=>{var y;return(y=this.inputsBuffer)==null||y.dispose(),this.inputsBuffer=createFloat64WasmBuffer(this.wasmModule,h),this.inputsBuffer.getArrayView()});let k;e.getOutputIndicesLength()>0?(e.copyOutputIndices((l=this.outputIndicesBuffer)==null?void 0:l.getArrayView(),h=>{var y;return(y=this.outputIndicesBuffer)==null||y.dispose(),this.outputIndicesBuffer=createInt32WasmBuffer(this.wasmModule,h),this.outputIndicesBuffer.getArrayView()}),k=this.outputIndicesBuffer):k=void 0;const S=e.getOutputsLength();(this.outputsBuffer===void 0||this.outputsBuffer.numElements<S)&&((p=this.outputsBuffer)==null||p.dispose(),this.outputsBuffer=createFloat64WasmBuffer(this.wasmModule,S));const O=perfNow();this.wasmRunModel(((v=this.inputsBuffer)==null?void 0:v.getAddress())||0,0,this.outputsBuffer.getAddress(),k?.getAddress()||0,z?.getAddress()||0,M?.getAddress()||0);const w=perfElapsed(O);e.storeOutputs(this.outputsBuffer.getArrayView()),e.storeElapsedTime(w)}terminate(){var e,i,n,t,_;(e=this.inputsBuffer)==null||e.dispose(),this.inputsBuffer=void 0,(i=this.outputsBuffer)==null||i.dispose(),this.outputsBuffer=void 0,(n=this.outputIndicesBuffer)==null||n.dispose(),this.outputIndicesBuffer=void 0,(t=this.constantValuesBuffer)==null||t.dispose(),this.constantValuesBuffer=void 0,(_=this.constantIndicesBuffer)==null||_.dispose(),this.constantIndicesBuffer=void 0}};function initWasmModel(e){return new WasmModel(e)}function createRunnableModel(e){switch(e.kind){case"js":return initJsModel(e);case"wasm":return initWasmModel(e);default:throw new Error("Unable to identify generated model kind")}}var initGeneratedModel,runnableModel,params=new BufferedRunModelParams,modelWorker={async initModel(){if(runnableModel)throw new Error("RunnableModel was already initialized");const e=await initGeneratedModel();return runnableModel=createRunnableModel(e),{outputVarIds:runnableModel.outputVarIds,modelListing:runnableModel.modelListing,startTime:runnableModel.startTime,endTime:runnableModel.endTime,saveFreq:runnableModel.saveFreq,outputRowLength:runnableModel.numSavePoints}},runModel(e){if(!runnableModel)throw new Error("RunnableModel must be initialized before running the model in worker");return params.updateFromEncodedBuffer(e),runnableModel.runModel(params),Transfer(e)}};function exposeModelWorker(e){initGeneratedModel=e,expose(modelWorker)}let __aux1,__aux2,__level1,__level2,_access_multiplier,_active_patient_ncd_related_service_utilization,_adjusted_annual_average_rdf,_adjusted_subsidies,_adjusted_total_cbhi_collected_fees,_adult_pop_with_coverage,_alpha,_annual_clinical_minutes_per_provider,_annual_health_service_utilization_per_ncd_patient,_annual_inflation_rate,_average_reimbursement_delay,_avg_adjusted_total_revolving_drug_funds,_avg_adult_pop_per_household,_base_average_fee_per_person,_base_average_reimbursement_per_person,_base_death_rate,_base_enrollment_rate,_base_medication_restocking_rate,_base_medication_utilization_rate,_base_ncd_screening_propensity=multiDimArray([2]),_base_positive_ncd_fraction_for_screened_people=multiDimArray([2]),_base_provider_per_facility,_base_tx_enrollment_rate_post_screening=multiDimArray([2]),_beta,_care_capacity_per_capita,_cbhi_beneficiaries,_cbhi_or_fee_waivered_patient_visits,_cbhi_paid,_cbhi_reimbursement_approval_fraction_data,_cbhi_reimbursements_approved,_cbhi_revenue,_change_in_demand_for_medications,_change_time,_collected_fees_and_subsidies,_data_adjusted_membership_cost_per_household,_data_adjusted_total_revolving_drug_funds,_data_amhara_total_population_30_yo_plus,_data_cbhi_membership_cost_per_household,_data_cbhi_targeted_households,_data_essential_medication_availability_avg,_data_essential_medication_availability_dia,_data_essential_medication_availability_htn,_data_inflation_conversion_multiplier_for_2017_birr_value,_data_total_cbhi_reimbursements,_data_total_cbhi_reimbursements_requested,_data_total_revolving_drug_funds,_death_of_at_risk_population=multiDimArray([2]),_death_of_treated_ncd_patients=multiDimArray([2]),_death_of_untreated_ncd_patients=multiDimArray([2]),_death_rate_for_untreated_ncd=multiDimArray([2]),_delay_reduction_strategy_start_year,_delay_reduction_strategy_strength,_demand_fulfilment_ratio,_demand_minutes_for_ncd,_demand_minutes_for_ncd_screening,_demand_minutes_for_non_ncd,_developing_ncd=multiDimArray([2]),_discontinuation_from_care=multiDimArray([2]),_discontinuation_rate=multiDimArray([2]),_dropout,_dropout_rate,_eff_of_coverage_on_service_utilization,_eff_of_health_coverage_on_screening=multiDimArray([2]),_eff_of_perceived_benefit_on_enrollment,_eligible_population_adjustment,_enrollment_strategy_start_year,_enrollment_strategy_strength,_essential_medication_availability,_facilities_in_amhara,_facilities_with_medication,_facilities_without_medication,_facility_stock_adjustment_time,_fee_waiver_adjustment_rate,_fee_waiver_enrollment_change,_fee_waiver_strategy_start_year,_fee_waiver_strategy_strength,_fee_waivered_insurance_coverage,_fee_waivered_population_with_health_coverage,_final_time,_frac_adult_of_pop_with_coverage,_fraction_allocated_to_rdf,_fraction_in_treatment=multiDimArray([2]),_fraction_not_in_treatment=multiDimArray([2]),_fraction_of_day_in_clinic_time,_household_adjustment_time,_household_size_adj_for_fees,_implied_cbhi_reimbursement_approval_fraction,_implied_delay,_implied_discontinuation_rate=multiDimArray([2]),_implied_eligible_households_not_enrolled,_implied_enrollment_rate,_implied_medication_restocking,_implied_medication_utilization_rate,_implied_positive_screening_rate=multiDimArray([2]),_implied_procurement_responsiveness,_implied_screening_propensity=multiDimArray([2]),_implied_tx_enrollment_frac_post_screening=multiDimArray([2]),_initial_adult_population=multiDimArray([2]),_initial_avg_adjusted_total_revolving_drug_funds,_initial_care_capacity_per_capita,_initial_cbhi_beneficiaries,_initial_cbhi_eligible_not_enrolled,_initial_cbhi_revenue,_initial_demand_for_medications,_initial_diagnosed_not_controlled_ncd=multiDimArray([2]),_initial_essential_medicine_availability,_initial_facilities_with_medication,_initial_facilities_without_medication,_initial_fee_waivered_population,_initial_fraction_in_treatment=multiDimArray([2]),_initial_fraction_not_in_treatment=multiDimArray([2]),_initial_health_insurance_coverage_rate,_initial_perceived_benefit,_initial_population_at_risk_of_developing_ncd=multiDimArray([2]),_initial_prevalence=multiDimArray([2]),_initial_prevalent_ncd=multiDimArray([2]),_initial_providers,_initial_time,_initial_tot_demand_minute_ratio,_initial_total_demand_minutes,_initial_undiagnosed_uncontrolled_ncd=multiDimArray([2]),_insured_service_utilization_per_capita,_internal_revenue_execution_rate,_max_provider_per_facility,_minutes_per_ncd_patient_year,_minutes_per_non_ncd_visit,_minutes_per_visit,_ncd_development_rate=multiDimArray([2]),_ncd_related_service_utilization,_ncd_related_service_utilization_per_capita,_ncd_screen_rate=multiDimArray([2]),_ncd_screening_related_service_utilization,_net_change_in_provider_availability,_net_enrollment_rate_in_2007,_new_enrollment_into_care=multiDimArray([2]),_new_enrollments,_new_fee_waiver_rate,_new_people_joining_at_risk_population,_new_utilization_for_dia_screen,_new_utilization_for_htn_screen,_non_ncd_visits,_ocm_rate_for_treated=multiDimArray([2]),_oneyear,_other_health_service_utilization,_people_in_informal_sector_not_enrolled_to_cbhi,_people_screened_for_ncd=multiDimArray([2]),_people_screened_positive_for_ncd=multiDimArray([2]),_percent_enrolled_in_cbhi,_population_adjustment,_population_at_risk_of_developing_ncd=multiDimArray([2]),_population_in_dia_treatment,_population_in_htn_treatment,_procurement_responsiveness,_provider_adjustment_rate,_provider_gap,_provider_number_strategy_strength,_provider_per_facility,_provider_productivity,_provider_productivity_strategy_start_year,_provider_strategy_start_year,_provider_strategy_strength,_reference_utilization_per_capita,_reimbursement_requests_from_cbhis,_reimbursement_strategy_start_year,_reimbursement_strategy_strength,_reimbursements,_relative_avg_adjusted_total_revolving_drug_funds,_relative_benefit,_relative_coverage_rate,_relative_death_risk_for_ncd=multiDimArray([2]),_relative_essential_medication_availability,_relative_untreated_ncd=multiDimArray([2]),_responsiveness_strategy_start_year,_responsiveness_strategy_strength,_restock_strategy_start_year,_restock_strategy_strength,_restocking_rate,_revenue_from_user_fees,_revenue_utilization_time,_saveper,_screen_strategy_start_year,_screen_strategy_strength,_screening_promotion_strategy,_stock_out_rate,_strategy_to_decrease_reimbursement_delay,_strategy_to_divert_unutilized_revenue,_strategy_to_increase_demand_responsiveness,_strategy_to_increase_enrollments,_strategy_to_increase_fee_waivers,_strategy_to_increase_provider_capacity,_strategy_to_increase_provider_productivity,_strategy_to_increase_reimbursement,_strategy_to_increase_restocking,_strength_coverage_on_screen=multiDimArray([2]),_strength_of_med_availability_on_discontinuation=multiDimArray([2]),_strength_of_med_availability_on_enrollment=multiDimArray([2]),_strength_of_perceived_benefit,_subsidy_fraction,_time_step,_time_to_enroll,_total_adult_population_with_coverage,_total_annual_clinical_minutes_per_provider,_total_demand_minutes,_total_internal_revenue,_total_ncd_care_demand_pop,_total_provider_minutes,_total_providers,_total_service_utilization_per_capita,_total_visits,_transition_time,_treated_ncd=multiDimArray([2]),_treated_ncd_death_risk_relative_to_untreated=multiDimArray([2]),_uninsured_patient_visits,_uninsured_service_utilization_per_capita,_untreated_ncd=multiDimArray([2]),_unutilized_internal_revenue,_unutilized_internal_revenue_per_facility,_unutilized_revenue_strategy_start_year,_unutilized_revenue_strategy_strength,_utilized_internal_revenue;const _data_amhara_total_population_30_yo_plus_data_=[2006,72e5,2007,69e5,2008,72e5,2009,75e5,2010,78e5,2011,81e5,2012,84e5,2013,87e5,2014,89e5,2015,92e5,2016,94e5,2017,97e5,2018,9910870,2019,10126300,2020,10346500,2021,10571400,2022,10801200,2023,11036e3,2024,11275900,2025,11521e3,2026,11771500,2027,12027400,2028,12288900],_data_cbhi_membership_cost_per_household_data_=[2005,106,2006,106,2007,144,2008,144,2009,170,2010,240,2011,240,2012,350,2013,450,2014,450,2015,750,2016,800,2017,1e3,2018,1133.79,2019,1269.64,2020,1384.56,2021,1496.82,2022,1618.18,2023,1749.39,2024,1891.23,2025,2044.57,2026,2210.35,2027,2389.56,2028,2583.31],_data_cbhi_targeted_households_data_=[2005,54212,2009,2684980,2010,3759270,2011,4341040,2012,4388960,2013,4020450,2014,4072840,2015,4122930,2016,4476440,2017,4573750,2018,4673180,2019,4774770,2020,4878570,2021,4984630,2022,5092990,2023,5203700,2024,5316830,2025,5432410,2026,5550510,2027,5671170,2028,5794460],_data_essential_medication_availability_dia_data_=[2007,.37,2009,.53,2011,.48],_data_essential_medication_availability_htn_data_=[2007,.36,2009,.41,2011,.42],_data_inflation_conversion_multiplier_for_2017_birr_value_data_=[2005,9.99513,2006,9.24909,2007,8.61183,2008,7.78777,2009,7.27159,2010,6.49446,2011,5.59608,2012,4.71136,2013,3.7523,2014,2.7452,2015,1.81486,2016,1.26643,2017,1,2018,.882,2019,.787626,2020,.722253,2021,.668084,2022,.617978,2023,.571629,2024,.528757,2025,.4891,2026,.452418,2027,.418487,2028,.3871],_data_total_cbhi_reimbursements_data_=[2013,574172e3,2014,734606e3,2015,147284e4,2016,453201e4],_data_total_cbhi_reimbursements_requested_data_=[2013,149806e4,2014,1089e6,2015,27445e5,2016,795548e4],_data_total_revolving_drug_funds_data_=[2005,143e6,2006,14418e4,2007,15e7,2008,174e6,2009,15e7,2010,1511e5,2011,183299e3,2012,187e6,2013,18964e4,2014,20933e4,2015,2616e5,2016,3285e5,2017,4615e5,2018,523243e3,2019,585938e3,2020,638973e3,2021,690781e3,2022,746791e3,2023,807341e3,2024,872801e3,2025,943569e3,2026,102007e4,2027,110278e4,2028,11922e5];let _time;function setTime(e){_time=e}let controlParamsInitialized=!1;function initControlParamsIfNeeded(){if(!controlParamsInitialized){if(fns===void 0)throw new Error("Must call setModelFunctions() before running the model");if(initConstants(),_initial_time===void 0)throw new Error("INITIAL TIME must be defined as a constant value");if(_time_step===void 0)throw new Error("TIME STEP must be defined as a constant value");if(_final_time===void 0||_saveper===void 0){if(setTime(_initial_time),fns.setContext({timeStep:_time_step,currentTime:_time}),initLevels(),evalAux(),_final_time===void 0)throw new Error("FINAL TIME must be defined");if(_saveper===void 0)throw new Error("SAVEPER must be defined")}controlParamsInitialized=!0}}function getInitialTime(){return initControlParamsIfNeeded(),_initial_time}function getFinalTime(){return initControlParamsIfNeeded(),_final_time}function getTimeStep(){return initControlParamsIfNeeded(),_time_step}function getSaveFreq(){return initControlParamsIfNeeded(),_saveper}let fns;function getModelFunctions(){return fns}function setModelFunctions(e){fns=e}function multiDimArray(e){if(e.length>0){const i=e[0],n=new Array(i);for(let t=0;t<i;t++)n[t]=multiDimArray(e.slice(1));return n}else return 0}let data_initialized=!1;function initData0(){_data_amhara_total_population_30_yo_plus=fns.createLookup(23,_data_amhara_total_population_30_yo_plus_data_),_data_cbhi_membership_cost_per_household=fns.createLookup(24,_data_cbhi_membership_cost_per_household_data_),_data_cbhi_targeted_households=fns.createLookup(21,_data_cbhi_targeted_households_data_),_data_essential_medication_availability_dia=fns.createLookup(3,_data_essential_medication_availability_dia_data_),_data_essential_medication_availability_htn=fns.createLookup(3,_data_essential_medication_availability_htn_data_),_data_inflation_conversion_multiplier_for_2017_birr_value=fns.createLookup(24,_data_inflation_conversion_multiplier_for_2017_birr_value_data_),_data_total_cbhi_reimbursements=fns.createLookup(4,_data_total_cbhi_reimbursements_data_),_data_total_cbhi_reimbursements_requested=fns.createLookup(4,_data_total_cbhi_reimbursements_requested_data_),_data_total_revolving_drug_funds=fns.createLookup(24,_data_total_revolving_drug_funds_data_)}function initData(){data_initialized||(initData0(),data_initialized=!0)}function initConstants0(){_final_time=2027,_initial_time=2007,_ncd_development_rate[1]=.01,_ncd_development_rate[0]=.02,_oneyear=1,_time_step=.125,_alpha=1,_annual_health_service_utilization_per_ncd_patient=2,_annual_inflation_rate=.25,_average_reimbursement_delay=1,_avg_adult_pop_per_household=2,_base_ncd_screening_propensity[1]=.005,_base_ncd_screening_propensity[0]=.01,_base_average_fee_per_person=3,_base_average_reimbursement_per_person=3,_base_death_rate=1e-4,_base_enrollment_rate=.05,_base_medication_restocking_rate=.2,_base_medication_utilization_rate=.7,_base_positive_ncd_fraction_for_screened_people[1]=.1,_base_positive_ncd_fraction_for_screened_people[0]=.2,_base_provider_per_facility=2,_base_tx_enrollment_rate_post_screening[1]=.5,_base_tx_enrollment_rate_post_screening[0]=.5,_beta=1,_change_time=1,_delay_reduction_strategy_start_year=2018,_delay_reduction_strategy_strength=0,_discontinuation_rate[1]=.25}function initConstants1(){_discontinuation_rate[0]=.2,_dropout_rate=.01,_eff_of_coverage_on_service_utilization=1.35,_enrollment_strategy_start_year=2018,_enrollment_strategy_strength=0,_facilities_in_amhara=1051,_facility_stock_adjustment_time=.25,_fee_waiver_adjustment_rate=.001,_fee_waiver_strategy_start_year=2018,_fee_waiver_strategy_strength=0,_fraction_allocated_to_rdf=.6,_fraction_of_day_in_clinic_time=.56,_household_adjustment_time=1,_household_size_adj_for_fees=1,_initial_cbhi_revenue=1e5,_initial_fee_waivered_population=26422,_initial_fraction_in_treatment[1]=.08,_initial_fraction_in_treatment[0]=.12,_initial_prevalence[1]=.078,_initial_prevalence[0]=.196,_initial_providers=50,_initial_tot_demand_minute_ratio=.5,_internal_revenue_execution_rate=.6,_minutes_per_visit=5,_net_enrollment_rate_in_2007=.53,_new_fee_waiver_rate=.001,_population_adjustment=4e5,_procurement_responsiveness=.5,_provider_adjustment_rate=10}function initConstants2(){_provider_number_strategy_strength=0,_provider_productivity_strategy_start_year=2018,_provider_strategy_start_year=2018,_provider_strategy_strength=0,_reference_utilization_per_capita=.1,_reimbursement_strategy_start_year=2018,_reimbursement_strategy_strength=0,_relative_death_risk_for_ncd[1]=2,_relative_death_risk_for_ncd[0]=2,_responsiveness_strategy_start_year=2018,_responsiveness_strategy_strength=0,_restock_strategy_start_year=2018,_restock_strategy_strength=0,_revenue_utilization_time=1,_screen_strategy_start_year=2018,_screen_strategy_strength=0,_strength_coverage_on_screen[1]=1,_strength_coverage_on_screen[0]=1,_strength_of_med_availability_on_discontinuation[1]=1,_strength_of_med_availability_on_discontinuation[0]=1,_strength_of_med_availability_on_enrollment[1]=1,_strength_of_med_availability_on_enrollment[0]=1,_strength_of_perceived_benefit=1,_subsidy_fraction=.1,_time_to_enroll=1,_total_annual_clinical_minutes_per_provider=1540*60,_transition_time=1,_treated_ncd_death_risk_relative_to_untreated[1]=.5,_treated_ncd_death_risk_relative_to_untreated[0]=.5,_unutilized_revenue_strategy_start_year=2018}function initConstants3(){_unutilized_revenue_strategy_strength=0}function initConstants(){initConstants0(),initConstants1(),initConstants2(),initConstants3(),initData()}function initLevels0(){_initial_cbhi_beneficiaries=_net_enrollment_rate_in_2007*fns.LOOKUP(_data_cbhi_targeted_households,_time),_data_essential_medication_availability_avg=(fns.LOOKUP(_data_essential_medication_availability_dia,_time)+fns.LOOKUP(_data_essential_medication_availability_htn,_time))/2,_initial_essential_medicine_availability=_data_essential_medication_availability_avg,_initial_facilities_with_medication=_initial_essential_medicine_availability*_facilities_in_amhara,_facilities_with_medication=_initial_facilities_with_medication,_initial_facilities_without_medication=(1-_initial_essential_medicine_availability)*_facilities_in_amhara,_facilities_without_medication=_initial_facilities_without_medication,_fee_waivered_population_with_health_coverage=_initial_fee_waivered_population,_cbhi_beneficiaries=_initial_cbhi_beneficiaries,_total_adult_population_with_coverage=(_cbhi_beneficiaries+_fee_waivered_population_with_health_coverage)*_avg_adult_pop_per_household,_frac_adult_of_pop_with_coverage=fns.MIN(_total_adult_population_with_coverage/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),1);for(let e=0;e<2;e++)_initial_adult_population[e]=fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time);_initial_population_at_risk_of_developing_ncd[0]=_initial_adult_population[0]*(1-_initial_prevalence[0]),_population_at_risk_of_developing_ncd[0]=_initial_population_at_risk_of_developing_ncd[0],_initial_prevalent_ncd[0]=_initial_adult_population[0]*_initial_prevalence[0],_initial_undiagnosed_uncontrolled_ncd[0]=_initial_prevalent_ncd[0]*(1-_initial_fraction_in_treatment[0]),_untreated_ncd[0]=_initial_undiagnosed_uncontrolled_ncd[0],__aux2=_time_step,_strategy_to_increase_provider_productivity=fns.STEP(_provider_strategy_strength*_alpha,_provider_productivity_strategy_start_year),_provider_productivity=fns.MIN(.57+_strategy_to_increase_provider_productivity,1),_annual_clinical_minutes_per_provider=_total_annual_clinical_minutes_per_provider*_fraction_of_day_in_clinic_time,_total_providers=_initial_providers,_total_provider_minutes=_total_providers*_annual_clinical_minutes_per_provider*_provider_productivity,_initial_total_demand_minutes=fns.ZIDZ(_total_provider_minutes,_initial_tot_demand_minute_ratio),__level2=_initial_total_demand_minutes*_time_step,_total_demand_minutes=__level2/__aux2,_demand_fulfilment_ratio=fns.MIN(1,fns.ZIDZ(_total_provider_minutes,_total_demand_minutes)),_initial_health_insurance_coverage_rate=_frac_adult_of_pop_with_coverage,_relative_coverage_rate=fns.ZIDZ(_frac_adult_of_pop_with_coverage,_initial_health_insurance_coverage_rate),_eff_of_health_coverage_on_screening[0]=fns.POW(_relative_coverage_rate,_strength_coverage_on_screen[0])}function initLevels1(){_screening_promotion_strategy=fns.STEP(_screen_strategy_strength*_beta,_screen_strategy_start_year)+1,_implied_screening_propensity[0]=_base_ncd_screening_propensity[0]*_screening_promotion_strategy,_ncd_screen_rate[0]=fns.MIN(_implied_screening_propensity[0]*_eff_of_health_coverage_on_screening[0]*_demand_fulfilment_ratio,1),_people_screened_for_ncd[0]=fns.MAX(_ncd_screen_rate[0]*(_untreated_ncd[0]+_population_at_risk_of_developing_ncd[0]),0),_new_utilization_for_htn_screen=_people_screened_for_ncd[0],_initial_population_at_risk_of_developing_ncd[1]=_initial_adult_population[1]*(1-_initial_prevalence[1]),_population_at_risk_of_developing_ncd[1]=_initial_population_at_risk_of_developing_ncd[1],_initial_prevalent_ncd[1]=_initial_adult_population[1]*_initial_prevalence[1],_initial_undiagnosed_uncontrolled_ncd[1]=_initial_prevalent_ncd[1]*(1-_initial_fraction_in_treatment[1]),_untreated_ncd[1]=_initial_undiagnosed_uncontrolled_ncd[1],_eff_of_health_coverage_on_screening[1]=fns.POW(_relative_coverage_rate,_strength_coverage_on_screen[1]),_implied_screening_propensity[1]=_base_ncd_screening_propensity[1]*_screening_promotion_strategy,_ncd_screen_rate[1]=fns.MIN(_implied_screening_propensity[1]*_eff_of_health_coverage_on_screening[1]*_demand_fulfilment_ratio,1),_people_screened_for_ncd[1]=fns.MAX(_ncd_screen_rate[1]*(_untreated_ncd[1]+_population_at_risk_of_developing_ncd[1]),0),_new_utilization_for_dia_screen=_people_screened_for_ncd[1],_ncd_screening_related_service_utilization=_new_utilization_for_dia_screen+_new_utilization_for_htn_screen,_initial_diagnosed_not_controlled_ncd[0]=_initial_prevalent_ncd[0]*_initial_fraction_in_treatment[0],_treated_ncd[0]=_initial_diagnosed_not_controlled_ncd[0],_population_in_htn_treatment=_treated_ncd[0],_initial_diagnosed_not_controlled_ncd[1]=_initial_prevalent_ncd[1]*_initial_fraction_in_treatment[1],_treated_ncd[1]=_initial_diagnosed_not_controlled_ncd[1],_population_in_dia_treatment=_treated_ncd[1],_active_patient_ncd_related_service_utilization=(_population_in_dia_treatment+_population_in_htn_treatment)*_annual_health_service_utilization_per_ncd_patient,_ncd_related_service_utilization=_active_patient_ncd_related_service_utilization+_ncd_screening_related_service_utilization,_ncd_related_service_utilization_per_capita=_ncd_related_service_utilization/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),_care_capacity_per_capita=_total_providers/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),_initial_care_capacity_per_capita=_care_capacity_per_capita,_access_multiplier=_care_capacity_per_capita/_initial_care_capacity_per_capita,_other_health_service_utilization=_reference_utilization_per_capita*_access_multiplier,_uninsured_service_utilization_per_capita=_other_health_service_utilization+_ncd_related_service_utilization_per_capita}function initLevels2(){_uninsured_patient_visits=_uninsured_service_utilization_per_capita*fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time)*(1-_frac_adult_of_pop_with_coverage),_revenue_from_user_fees=_uninsured_patient_visits*_base_average_fee_per_person/_facilities_in_amhara,_strategy_to_decrease_reimbursement_delay=1-fns.STEP(_delay_reduction_strategy_strength*_beta,_delay_reduction_strategy_start_year),_implied_delay=fns.MAX(_average_reimbursement_delay*_strategy_to_decrease_reimbursement_delay,_time_step),__aux1=_implied_delay,_cbhi_revenue=_initial_cbhi_revenue,_strategy_to_increase_reimbursement=fns.STEP(_reimbursement_strategy_strength*_beta,_reimbursement_strategy_start_year),_cbhi_reimbursement_approval_fraction_data=fns.ZIDZ(fns.LOOKUP(_data_total_cbhi_reimbursements,_time),fns.LOOKUP(_data_total_cbhi_reimbursements_requested,_time)),_implied_cbhi_reimbursement_approval_fraction=fns.MIN(_cbhi_reimbursement_approval_fraction_data+_strategy_to_increase_reimbursement,1),_adult_pop_with_coverage=fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time)*_frac_adult_of_pop_with_coverage,_insured_service_utilization_per_capita=(_other_health_service_utilization+_ncd_related_service_utilization_per_capita)*_eff_of_coverage_on_service_utilization,_cbhi_or_fee_waivered_patient_visits=_insured_service_utilization_per_capita*_adult_pop_with_coverage,_reimbursement_requests_from_cbhis=_cbhi_or_fee_waivered_patient_visits*_base_average_reimbursement_per_person,_cbhi_reimbursements_approved=fns.MIN(_reimbursement_requests_from_cbhis*_implied_cbhi_reimbursement_approval_fraction,_cbhi_revenue/_revenue_utilization_time),__level1=_cbhi_reimbursements_approved*_implied_delay,_cbhi_paid=__level1/__aux1/fns.POW(1+_annual_inflation_rate*_oneyear,_implied_delay/_oneyear),_reimbursements=_cbhi_paid/_facilities_in_amhara,_total_internal_revenue=_reimbursements+_revenue_from_user_fees,_utilized_internal_revenue=_total_internal_revenue*_internal_revenue_execution_rate,_strategy_to_divert_unutilized_revenue=fns.STEP(_unutilized_revenue_strategy_strength*_beta,_unutilized_revenue_strategy_start_year),_unutilized_internal_revenue=_total_internal_revenue-_utilized_internal_revenue,_data_adjusted_total_revolving_drug_funds=fns.LOOKUP(_data_total_revolving_drug_funds,_time)*fns.LOOKUP(_data_inflation_conversion_multiplier_for_2017_birr_value,_time),_avg_adjusted_total_revolving_drug_funds=_data_adjusted_total_revolving_drug_funds/_facilities_in_amhara,_unutilized_internal_revenue_per_facility=_unutilized_internal_revenue*_strategy_to_divert_unutilized_revenue,_adjusted_annual_average_rdf=_unutilized_internal_revenue_per_facility+_avg_adjusted_total_revolving_drug_funds+(_revenue_from_user_fees+_reimbursements)*_fraction_allocated_to_rdf,_initial_avg_adjusted_total_revolving_drug_funds=_adjusted_annual_average_rdf;let e=0;for(let i=0;i<2;i++)e+=_treated_ncd[i];_total_ncd_care_demand_pop=e,_initial_demand_for_medications=_total_ncd_care_demand_pop,_fraction_in_treatment[1]=_treated_ncd[1]/(_untreated_ncd[1]+_treated_ncd[1]),_fraction_not_in_treatment[1]=1-_fraction_in_treatment[1]}function initLevels3(){_initial_fraction_not_in_treatment[1]=_fraction_not_in_treatment[1],_fraction_in_treatment[0]=_treated_ncd[0]/(_untreated_ncd[0]+_treated_ncd[0]),_fraction_not_in_treatment[0]=1-_fraction_in_treatment[0],_initial_fraction_not_in_treatment[0]=_fraction_not_in_treatment[0],_initial_cbhi_eligible_not_enrolled=(1-_net_enrollment_rate_in_2007)*fns.LOOKUP(_data_cbhi_targeted_households,_time),_people_in_informal_sector_not_enrolled_to_cbhi=_initial_cbhi_eligible_not_enrolled,_percent_enrolled_in_cbhi=_cbhi_beneficiaries/(_cbhi_beneficiaries+_people_in_informal_sector_not_enrolled_to_cbhi),_initial_perceived_benefit=_percent_enrolled_in_cbhi}function initLevels(){initLevels0(),initLevels1(),initLevels2(),initLevels3()}function evalAux0(){_saveper=_time_step,_death_of_at_risk_population[1]=fns.MIN(_base_death_rate*_population_at_risk_of_developing_ncd[1],_population_at_risk_of_developing_ncd[1]/_transition_time),_death_of_at_risk_population[0]=fns.MIN(_base_death_rate*_population_at_risk_of_developing_ncd[0],_population_at_risk_of_developing_ncd[0]/_transition_time),_developing_ncd[1]=fns.MIN(_population_at_risk_of_developing_ncd[1]*_ncd_development_rate[1],_population_at_risk_of_developing_ncd[1]/_transition_time),_developing_ncd[0]=fns.MIN(_population_at_risk_of_developing_ncd[0]*_ncd_development_rate[0],_population_at_risk_of_developing_ncd[0]/_transition_time),_dropout=fns.MAX(fns.MIN(_cbhi_beneficiaries*_dropout_rate,_cbhi_beneficiaries/_change_time),0),_fee_waiver_enrollment_change=fns.MIN(_fee_waivered_population_with_health_coverage*_fee_waiver_adjustment_rate,_fee_waivered_population_with_health_coverage/_change_time),_initial_cbhi_beneficiaries=_net_enrollment_rate_in_2007*fns.LOOKUP(_data_cbhi_targeted_households,_time),_initial_cbhi_eligible_not_enrolled=(1-_net_enrollment_rate_in_2007)*fns.LOOKUP(_data_cbhi_targeted_households,_time),_initial_population_at_risk_of_developing_ncd[1]=_initial_adult_population[1]*(1-_initial_prevalence[1]),_initial_population_at_risk_of_developing_ncd[0]=_initial_adult_population[0]*(1-_initial_prevalence[0]),_new_people_joining_at_risk_population=_population_adjustment,_strategy_to_divert_unutilized_revenue=fns.STEP(_unutilized_revenue_strategy_strength*_beta,_unutilized_revenue_strategy_start_year),_total_adult_population_with_coverage=(_cbhi_beneficiaries+_fee_waivered_population_with_health_coverage)*_avg_adult_pop_per_household,_frac_adult_of_pop_with_coverage=fns.MIN(_total_adult_population_with_coverage/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),1),__aux2=_time_step,_total_demand_minutes=__level2/__aux2,_strategy_to_increase_provider_productivity=fns.STEP(_provider_strategy_strength*_alpha,_provider_productivity_strategy_start_year),_provider_productivity=fns.MIN(.57+_strategy_to_increase_provider_productivity,1),_annual_clinical_minutes_per_provider=_total_annual_clinical_minutes_per_provider*_fraction_of_day_in_clinic_time,_total_provider_minutes=_total_providers*_annual_clinical_minutes_per_provider*_provider_productivity,_demand_fulfilment_ratio=fns.MIN(1,fns.ZIDZ(_total_provider_minutes,_total_demand_minutes)),_relative_coverage_rate=fns.ZIDZ(_frac_adult_of_pop_with_coverage,_initial_health_insurance_coverage_rate),_eff_of_health_coverage_on_screening[0]=fns.POW(_relative_coverage_rate,_strength_coverage_on_screen[0]),_screening_promotion_strategy=fns.STEP(_screen_strategy_strength*_beta,_screen_strategy_start_year)+1,_implied_screening_propensity[0]=_base_ncd_screening_propensity[0]*_screening_promotion_strategy,_ncd_screen_rate[0]=fns.MIN(_implied_screening_propensity[0]*_eff_of_health_coverage_on_screening[0]*_demand_fulfilment_ratio,1),_people_screened_for_ncd[0]=fns.MAX(_ncd_screen_rate[0]*(_untreated_ncd[0]+_population_at_risk_of_developing_ncd[0]),0),_new_utilization_for_htn_screen=_people_screened_for_ncd[0],_eff_of_health_coverage_on_screening[1]=fns.POW(_relative_coverage_rate,_strength_coverage_on_screen[1])}function evalAux1(){_implied_screening_propensity[1]=_base_ncd_screening_propensity[1]*_screening_promotion_strategy,_ncd_screen_rate[1]=fns.MIN(_implied_screening_propensity[1]*_eff_of_health_coverage_on_screening[1]*_demand_fulfilment_ratio,1),_people_screened_for_ncd[1]=fns.MAX(_ncd_screen_rate[1]*(_untreated_ncd[1]+_population_at_risk_of_developing_ncd[1]),0),_new_utilization_for_dia_screen=_people_screened_for_ncd[1],_ncd_screening_related_service_utilization=_new_utilization_for_dia_screen+_new_utilization_for_htn_screen,_population_in_htn_treatment=_treated_ncd[0],_population_in_dia_treatment=_treated_ncd[1],_active_patient_ncd_related_service_utilization=(_population_in_dia_treatment+_population_in_htn_treatment)*_annual_health_service_utilization_per_ncd_patient,_ncd_related_service_utilization=_active_patient_ncd_related_service_utilization+_ncd_screening_related_service_utilization,_ncd_related_service_utilization_per_capita=_ncd_related_service_utilization/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),_care_capacity_per_capita=_total_providers/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time),_access_multiplier=_care_capacity_per_capita/_initial_care_capacity_per_capita,_other_health_service_utilization=_reference_utilization_per_capita*_access_multiplier,_uninsured_service_utilization_per_capita=_other_health_service_utilization+_ncd_related_service_utilization_per_capita,_uninsured_patient_visits=_uninsured_service_utilization_per_capita*fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time)*(1-_frac_adult_of_pop_with_coverage),_revenue_from_user_fees=_uninsured_patient_visits*_base_average_fee_per_person/_facilities_in_amhara,_strategy_to_decrease_reimbursement_delay=1-fns.STEP(_delay_reduction_strategy_strength*_beta,_delay_reduction_strategy_start_year),_implied_delay=fns.MAX(_average_reimbursement_delay*_strategy_to_decrease_reimbursement_delay,_time_step),__aux1=_implied_delay,_cbhi_paid=__level1/__aux1/fns.POW(1+_annual_inflation_rate*_oneyear,_implied_delay/_oneyear),_reimbursements=_cbhi_paid/_facilities_in_amhara,_total_internal_revenue=_reimbursements+_revenue_from_user_fees,_utilized_internal_revenue=_total_internal_revenue*_internal_revenue_execution_rate,_unutilized_internal_revenue=_total_internal_revenue-_utilized_internal_revenue,_adult_pop_with_coverage=fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time)*_frac_adult_of_pop_with_coverage,_insured_service_utilization_per_capita=(_other_health_service_utilization+_ncd_related_service_utilization_per_capita)*_eff_of_coverage_on_service_utilization,_cbhi_or_fee_waivered_patient_visits=_insured_service_utilization_per_capita*_adult_pop_with_coverage,_total_visits=_cbhi_or_fee_waivered_patient_visits+_uninsured_patient_visits,_total_service_utilization_per_capita=_total_visits/fns.LOOKUP(_data_amhara_total_population_30_yo_plus,_time);let e=0;for(let i=0;i<2;i++)e+=_treated_ncd[i];_total_ncd_care_demand_pop=e}function evalAux2(){_change_in_demand_for_medications=_total_ncd_care_demand_pop/_initial_demand_for_medications,_implied_medication_utilization_rate=_base_medication_utilization_rate*_change_in_demand_for_medications,_stock_out_rate=fns.MIN(_facilities_with_medication*_implied_medication_utilization_rate,_facilities_with_medication/_facility_stock_adjustment_time),_strategy_to_increase_restocking=fns.STEP(_restock_strategy_strength*_beta,_restock_strategy_start_year)+1,_strategy_to_increase_demand_responsiveness=fns.STEP(_responsiveness_strategy_strength*_beta,_responsiveness_strategy_start_year)+1,_implied_procurement_responsiveness=_strategy_to_increase_demand_responsiveness*_procurement_responsiveness,_data_adjusted_total_revolving_drug_funds=fns.LOOKUP(_data_total_revolving_drug_funds,_time)*fns.LOOKUP(_data_inflation_conversion_multiplier_for_2017_birr_value,_time),_avg_adjusted_total_revolving_drug_funds=_data_adjusted_total_revolving_drug_funds/_facilities_in_amhara,_unutilized_internal_revenue_per_facility=_unutilized_internal_revenue*_strategy_to_divert_unutilized_revenue,_adjusted_annual_average_rdf=_unutilized_internal_revenue_per_facility+_avg_adjusted_total_revolving_drug_funds+(_revenue_from_user_fees+_reimbursements)*_fraction_allocated_to_rdf,_relative_avg_adjusted_total_revolving_drug_funds=_adjusted_annual_average_rdf/_initial_avg_adjusted_total_revolving_drug_funds,_implied_medication_restocking=_base_medication_restocking_rate*_relative_avg_adjusted_total_revolving_drug_funds*fns.POW(_change_in_demand_for_medications,_implied_procurement_responsiveness)*_strategy_to_increase_restocking,_restocking_rate=fns.MIN(_facilities_without_medication*_implied_medication_restocking,_facilities_without_medication/_facility_stock_adjustment_time),_essential_medication_availability=_facilities_with_medication/(_facilities_with_medication+_facilities_without_medication),_percent_enrolled_in_cbhi=_cbhi_beneficiaries/(_cbhi_beneficiaries+_people_in_informal_sector_not_enrolled_to_cbhi),_provider_per_facility=_total_providers/_facilities_in_amhara,_strategy_to_increase_enrollments=fns.STEP(_enrollment_strategy_strength*_beta,_enrollment_strategy_start_year)+1,_relative_benefit=fns.ZIDZ(_percent_enrolled_in_cbhi,_initial_perceived_benefit),_eff_of_perceived_benefit_on_enrollment=fns.POW(_relative_benefit,_strength_of_perceived_benefit),_implied_enrollment_rate=_base_enrollment_rate*_eff_of_perceived_benefit_on_enrollment,_new_enrollments=fns.MIN(_people_in_informal_sector_not_enrolled_to_cbhi*_implied_enrollment_rate*_strategy_to_increase_enrollments,_people_in_informal_sector_not_enrolled_to_cbhi*_strategy_to_increase_enrollments/_time_to_enroll),_fraction_in_treatment[0]=_treated_ncd[0]/(_untreated_ncd[0]+_treated_ncd[0]),_fraction_not_in_treatment[0]=1-_fraction_in_treatment[0],_relative_untreated_ncd[0]=_fraction_not_in_treatment[0]/_initial_fraction_not_in_treatment[0],_implied_positive_screening_rate[0]=_base_positive_ncd_fraction_for_screened_people[0]*_relative_untreated_ncd[0],_people_screened_positive_for_ncd[0]=_people_screened_for_ncd[0]*_implied_positive_screening_rate[0],_data_essential_medication_availability_avg=(fns.LOOKUP(_data_essential_medication_availability_dia,_time)+fns.LOOKUP(_data_essential_medication_availability_htn,_time))/2,_initial_essential_medicine_availability=_data_essential_medication_availability_avg,_relative_essential_medication_availability=fns.ZIDZ(_essential_medication_availability,_initial_essential_medicine_availability),_implied_tx_enrollment_frac_post_screening[0]=_base_tx_enrollment_rate_post_screening[0]*_demand_fulfilment_ratio*fns.POW(_relative_essential_medication_availability,_strength_of_med_availability_on_enrollment[0])}function evalAux3(){_new_enrollment_into_care[0]=fns.MIN(_people_screened_positive_for_ncd[0]*_implied_tx_enrollment_frac_post_screening[0],_untreated_ncd[0]/_transition_time),_fraction_in_treatment[1]=_treated_ncd[1]/(_untreated_ncd[1]+_treated_ncd[1]),_fraction_not_in_treatment[1]=1-_fraction_in_treatment[1],_relative_untreated_ncd[1]=_fraction_not_in_treatment[1]/_initial_fraction_not_in_treatment[1],_implied_positive_screening_rate[1]=_base_positive_ncd_fraction_for_screened_people[1]*_relative_untreated_ncd[1],_people_screened_positive_for_ncd[1]=_people_screened_for_ncd[1]*_implied_positive_screening_rate[1],_implied_tx_enrollment_frac_post_screening[1]=_base_tx_enrollment_rate_post_screening[1]*_demand_fulfilment_ratio*fns.POW(_relative_essential_medication_availability,_strength_of_med_availability_on_enrollment[1]),_new_enrollment_into_care[1]=fns.MIN(_people_screened_positive_for_ncd[1]*_implied_tx_enrollment_frac_post_screening[1],_untreated_ncd[1]/_transition_time),_strategy_to_increase_provider_capacity=fns.STEP(_provider_number_strategy_strength*_alpha,_provider_strategy_start_year)+1,_max_provider_per_facility=_base_provider_per_facility*_strategy_to_increase_provider_capacity,_provider_gap=fns.MAX(_max_provider_per_facility-_provider_per_facility,0),_net_change_in_provider_availability=fns.ZIDZ(_provider_gap,_max_provider_per_facility)*_provider_adjustment_rate,_initial_prevalent_ncd[0]=_initial_adult_population[0]*_initial_prevalence[0],_initial_undiagnosed_uncontrolled_ncd[0]=_initial_prevalent_ncd[0]*(1-_initial_fraction_in_treatment[0]),_initial_prevalent_ncd[1]=_initial_adult_population[1]*_initial_prevalence[1],_initial_undiagnosed_uncontrolled_ncd[1]=_initial_prevalent_ncd[1]*(1-_initial_fraction_in_treatment[1]),_initial_total_demand_minutes=fns.ZIDZ(_total_provider_minutes,_initial_tot_demand_minute_ratio),_initial_facilities_without_medication=(1-_initial_essential_medicine_availability)*_facilities_in_amhara,_initial_facilities_with_medication=_initial_essential_medicine_availability*_facilities_in_amhara,_initial_diagnosed_not_controlled_ncd[0]=_initial_prevalent_ncd[0]*_initial_fraction_in_treatment[0],_initial_diagnosed_not_controlled_ncd[1]=_initial_prevalent_ncd[1]*_initial_fraction_in_treatment[1],_strategy_to_increase_reimbursement=fns.STEP(_reimbursement_strategy_strength*_beta,_reimbursement_strategy_start_year),_cbhi_reimbursement_approval_fraction_data=fns.ZIDZ(fns.LOOKUP(_data_total_cbhi_reimbursements,_time),fns.LOOKUP(_data_total_cbhi_reimbursements_requested,_time)),_strategy_to_increase_fee_waivers=fns.STEP(_fee_waiver_strategy_strength*_beta,_fee_waiver_strategy_start_year)+1,_fee_waivered_insurance_coverage=fns.MIN(_people_in_informal_sector_not_enrolled_to_cbhi*_new_fee_waiver_rate*_strategy_to_increase_fee_waivers,_people_in_informal_sector_not_enrolled_to_cbhi*_strategy_to_increase_fee_waivers/_time_to_enroll),_implied_eligible_households_not_enrolled=fns.LOOKUP(_data_cbhi_targeted_households,_time)-(_cbhi_beneficiaries+_fee_waivered_population_with_health_coverage),_eligible_population_adjustment=fns.MAX((_implied_eligible_households_not_enrolled-_people_in_informal_sector_not_enrolled_to_cbhi)/_household_adjustment_time,0),_implied_discontinuation_rate[0]=_discontinuation_rate[0]*(2/(1+_demand_fulfilment_ratio))*fns.POW(_relative_essential_medication_availability,-_strength_of_med_availability_on_discontinuation[0]),_discontinuation_from_care[0]=fns.MIN(_treated_ncd[0]*_implied_discontinuation_rate[0],_treated_ncd[0]/_transition_time),_implied_discontinuation_rate[1]=_discontinuation_rate[1]*(2/(1+_demand_fulfilment_ratio))*fns.POW(_relative_essential_medication_availability,-_strength_of_med_availability_on_discontinuation[1])}function evalAux4(){_discontinuation_from_care[1]=fns.MIN(_treated_ncd[1]*_implied_discontinuation_rate[1],_treated_ncd[1]/_transition_time),_minutes_per_non_ncd_visit=_minutes_per_visit,_non_ncd_visits=_total_visits-_active_patient_ncd_related_service_utilization-_ncd_screening_related_service_utilization,_demand_minutes_for_non_ncd=_non_ncd_visits*_minutes_per_non_ncd_visit,_demand_minutes_for_ncd_screening=_ncd_screening_related_service_utilization*_minutes_per_visit,_minutes_per_ncd_patient_year=_annual_health_service_utilization_per_ncd_patient*_minutes_per_visit,_demand_minutes_for_ncd=_total_ncd_care_demand_pop*_minutes_per_ncd_patient_year,_death_rate_for_untreated_ncd[0]=_base_death_rate*_relative_death_risk_for_ncd[0],_death_of_untreated_ncd_patients[0]=fns.MIN(_untreated_ncd[0]*_death_rate_for_untreated_ncd[0],_untreated_ncd[0]/_transition_time),_death_rate_for_untreated_ncd[1]=_base_death_rate*_relative_death_risk_for_ncd[1],_death_of_untreated_ncd_patients[1]=fns.MIN(_untreated_ncd[1]*_death_rate_for_untreated_ncd[1],_untreated_ncd[1]/_transition_time),_ocm_rate_for_treated[0]=_death_rate_for_untreated_ncd[0]*_treated_ncd_death_risk_relative_to_untreated[0],_death_of_treated_ncd_patients[0]=fns.MIN(_treated_ncd[0]*_ocm_rate_for_treated[0],_treated_ncd[0]/_transition_time),_ocm_rate_for_treated[1]=_death_rate_for_untreated_ncd[1]*_treated_ncd_death_risk_relative_to_untreated[1],_death_of_treated_ncd_patients[1]=fns.MIN(_treated_ncd[1]*_ocm_rate_for_treated[1],_treated_ncd[1]/_transition_time),_data_adjusted_membership_cost_per_household=fns.LOOKUP(_data_cbhi_membership_cost_per_household,_time)*fns.LOOKUP(_data_inflation_conversion_multiplier_for_2017_birr_value,_time),_adjusted_total_cbhi_collected_fees=_data_adjusted_membership_cost_per_household*_cbhi_beneficiaries*_household_size_adj_for_fees,_adjusted_subsidies=_adjusted_total_cbhi_collected_fees*_subsidy_fraction,_collected_fees_and_subsidies=_adjusted_total_cbhi_collected_fees+_adjusted_subsidies,_implied_cbhi_reimbursement_approval_fraction=fns.MIN(_cbhi_reimbursement_approval_fraction_data+_strategy_to_increase_reimbursement,1),_reimbursement_requests_from_cbhis=_cbhi_or_fee_waivered_patient_visits*_base_average_reimbursement_per_person,_cbhi_reimbursements_approved=fns.MIN(_reimbursement_requests_from_cbhis*_implied_cbhi_reimbursement_approval_fraction,_cbhi_revenue/_revenue_utilization_time)}function evalAux(){evalAux0(),evalAux1(),evalAux2(),evalAux3(),evalAux4()}function evalLevels0(){_cbhi_beneficiaries=fns.INTEG(_cbhi_beneficiaries,_new_enrollments-_dropout),_cbhi_revenue=fns.INTEG(_cbhi_revenue,_collected_fees_and_subsidies-_cbhi_reimbursements_approved),_facilities_with_medication=fns.INTEG(_facilities_with_medication,_restocking_rate-_stock_out_rate),_facilities_without_medication=fns.INTEG(_facilities_without_medication,_stock_out_rate-_restocking_rate),_fee_waivered_population_with_health_coverage=fns.INTEG(_fee_waivered_population_with_health_coverage,_fee_waivered_insurance_coverage-_fee_waiver_enrollment_change),_people_in_informal_sector_not_enrolled_to_cbhi=fns.INTEG(_people_in_informal_sector_not_enrolled_to_cbhi,_dropout+_eligible_population_adjustment+_fee_waiver_enrollment_change-_fee_waivered_insurance_coverage-_new_enrollments),_population_at_risk_of_developing_ncd[1]=fns.INTEG(_population_at_risk_of_developing_ncd[1],_new_people_joining_at_risk_population-_death_of_at_risk_population[1]-_developing_ncd[1]),_population_at_risk_of_developing_ncd[0]=fns.INTEG(_population_at_risk_of_developing_ncd[0],_new_people_joining_at_risk_population-_death_of_at_risk_population[0]-_developing_ncd[0]),_total_providers=fns.INTEG(_total_providers,_net_change_in_provider_availability),_treated_ncd[1]=fns.INTEG(_treated_ncd[1],_new_enrollment_into_care[1]-_discontinuation_from_care[1]-_death_of_treated_ncd_patients[1]),_treated_ncd[0]=fns.INTEG(_treated_ncd[0],_new_enrollment_into_care[0]-_discontinuation_from_care[0]-_death_of_treated_ncd_patients[0]),_untreated_ncd[1]=fns.INTEG(_untreated_ncd[1],_developing_ncd[1]-_new_enrollment_into_care[1]-_death_of_untreated_ncd_patients[1]+_discontinuation_from_care[1]),_untreated_ncd[0]=fns.INTEG(_untreated_ncd[0],_developing_ncd[0]-_new_enrollment_into_care[0]-_death_of_untreated_ncd_patients[0]+_discontinuation_from_care[0]),__level1=fns.INTEG(__level1,_cbhi_reimbursements_approved-_cbhi_paid),__level2=fns.INTEG(__level2,_demand_minutes_for_non_ncd+_demand_minutes_for_ncd+_demand_minutes_for_ncd_screening-_total_demand_minutes)}function evalLevels(){evalLevels0()}function setInputs(e){_enrollment_strategy_strength=e(0),_fee_waiver_strategy_strength=e(1),_delay_reduction_strategy_strength=e(2),_reimbursement_strategy_strength=e(3),_screen_strategy_strength=e(4),_provider_number_strategy_strength=e(5),_provider_strategy_strength=e(6),_restock_strategy_strength=e(7),_unutilized_revenue_strategy_strength=e(8),_dropout_rate=e(9),_base_enrollment_rate=e(10),_new_fee_waiver_rate=e(11),_fee_waiver_adjustment_rate=e(12),_strength_of_perceived_benefit=e(13),_initial_fee_waivered_population=e(14),_population_adjustment=e(15),_ncd_development_rate[0]=e(16),_base_ncd_screening_propensity[0]=e(17),_base_ncd_screening_propensity[1]=e(18),_treated_ncd_death_risk_relative_to_untreated[0]=e(19),_discontinuation_rate[0]=e(20),_strength_coverage_on_screen[0]=e(21),_ncd_development_rate[1]=e(22),_base_tx_enrollment_rate_post_screening[1]=e(23),_base_tx_enrollment_rate_post_screening[0]=e(24),_relative_death_risk_for_ncd[1]=e(25),_relative_death_risk_for_ncd[0]=e(26),_treated_ncd_death_risk_relative_to_untreated[1]=e(27),_discontinuation_rate[1]=e(28),_base_death_rate=e(29),_strength_coverage_on_screen[1]=e(30),_base_positive_ncd_fraction_for_screened_people[0]=e(31),_base_positive_ncd_fraction_for_screened_people[1]=e(32),_reference_utilization_per_capita=e(33),_base_average_fee_per_person=e(34),_base_average_reimbursement_per_person=e(35),e(36),e(37),_initial_cbhi_revenue=e(38),_provider_adjustment_rate=e(39),_initial_providers=e(40),_base_medication_restocking_rate=e(41),_subsidy_fraction=e(42),_initial_prevalence[0]=e(43),_initial_prevalence[1]=e(44),_initial_fraction_in_treatment[0]=e(45),_initial_fraction_in_treatment[1]=e(46),_internal_revenue_execution_rate=e(47),_strength_of_med_availability_on_enrollment[0]=e(48),_strength_of_med_availability_on_enrollment[1]=e(49),_strength_of_med_availability_on_discontinuation[0]=e(50),_strength_of_med_availability_on_discontinuation[1]=e(51)}function setConstant(e,i){throw new Error("The setConstant function was not enabled for the generated model. Set the customConstants property in the spec/config file to allow for overriding constants at runtime.")}function setLookup(e,i){throw new Error("The setLookup function was not enabled for the generated model. Set the customLookups property in the spec/config file to allow for overriding lookups at runtime.")}const outputVarIds=["_cbhi_beneficiaries","_fee_waivered_population_with_health_coverage","_fraction_in_treatment[_dia]","_fraction_in_treatment[_htn]","_essential_medication_availability","_frac_adult_of_pop_with_coverage","_new_enrollment_into_care[_dia]","_new_enrollment_into_care[_htn]","_people_screened_for_ncd[_dia]","_people_screened_for_ncd[_htn]","_total_service_utilization_per_capita"],outputVarNames=["CBHI beneficiaries","Fee waivered population with health coverage","Fraction in treatment[DIA]","Fraction in treatment[HTN]","essential medication availability","frac adult of pop with coverage","new enrollment into care[DIA]","new enrollment into care[HTN]","people screened for NCD[DIA]","people screened for NCD[HTN]","total service utilization per capita"];function storeOutputs(e){e(_cbhi_beneficiaries),e(_fee_waivered_population_with_health_coverage),e(_fraction_in_treatment[1]),e(_fraction_in_treatment[0]),e(_essential_medication_availability),e(_frac_adult_of_pop_with_coverage),e(_new_enrollment_into_care[1]),e(_new_enrollment_into_care[0]),e(_people_screened_for_ncd[1]),e(_people_screened_for_ncd[0]),e(_total_service_utilization_per_capita)}function storeOutput(e,i){throw new Error("The storeOutput function was not enabled for the generated model. Set the customOutputs property in the spec/config file to allow for capturing arbitrary variables at runtime.")}const modelListing=void 0;async function loadGeneratedModel(){return{kind:"js",outputVarIds,outputVarNames,modelListing,getInitialTime,getFinalTime,getTimeStep,getSaveFreq,getModelFunctions,setModelFunctions,setTime,setInputs,setConstant,setLookup,storeOutputs,storeOutput,initConstants,initLevels,evalAux,evalLevels}}exposeModelWorker(loadGeneratedModel)})();\n';
