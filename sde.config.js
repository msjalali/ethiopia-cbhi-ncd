...
const deployBaseUrl = 'https://msjalali.github.io/ethiopia-cbhi-ncd'
...
export async function config() {
  return {
    ...
    // of platform.
    watchPaths: ['config/**', 'EthiopiaHCF-V26_MJ.mdl'],
